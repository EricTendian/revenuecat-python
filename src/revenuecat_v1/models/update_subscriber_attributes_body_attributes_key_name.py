...
T = TypeVar("T", bound="UpdateSubscriberAttributesBodyAttributesKeyName")


@_attrs_define
class UpdateSubscriberAttributesBodyAttributesKeyName:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_subscriber_attributes_body_attributes_key_name = cls(
            value=value,
            updated_at_ms=updated_at_ms,
        )

        update_subscriber_attributes_body_attributes_key_name.additional_properties = d
        return update_subscriber_attributes_body_attributes_key_name
