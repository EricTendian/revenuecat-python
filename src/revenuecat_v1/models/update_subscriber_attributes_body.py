...
if TYPE_CHECKING:
    from ..models.update_subscriber_attributes_body_attributes import UpdateSubscriberAttributesBodyAttributes
...
class UpdateSubscriberAttributesBody:
    """
    Attributes:
        attributes (UpdateSubscriberAttributesBodyAttributes | Unset):
    """

    attributes: UpdateSubscriberAttributesBodyAttributes | Unset = UNSET
