...
from ..models.get_overview_metrics_response_423_type import GetOverviewMetricsResponse423Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetOverviewMetricsResponse423")


@_attrs_define
class GetOverviewMetricsResponse423:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetOverviewMetricsResponse423Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetOverviewMetricsResponse423Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetOverviewMetricsResponse423Type(d.pop("type"))
        ...
        get_overview_metrics_response_423 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_overview_metrics_response_423.additional_properties = d
        return get_overview_metrics_response_423
