...
from ..models.update_package_response_400_type import UpdatePackageResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdatePackageResponse400")


@_attrs_define
class UpdatePackageResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (UpdatePackageResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: UpdatePackageResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = UpdatePackageResponse400Type(d.pop("type"))
        ...
        update_package_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        update_package_response_400.additional_properties = d
        return update_package_response_400
