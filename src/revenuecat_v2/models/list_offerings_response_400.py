...
from ..models.list_offerings_response_400_type import ListOfferingsResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListOfferingsResponse400")


@_attrs_define
class ListOfferingsResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListOfferingsResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListOfferingsResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListOfferingsResponse400Type(d.pop("type"))
        ...
        list_offerings_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_offerings_response_400.additional_properties = d
        return list_offerings_response_400
