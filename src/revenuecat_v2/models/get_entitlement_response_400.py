...
from ..models.get_entitlement_response_400_type import GetEntitlementResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetEntitlementResponse400")


@_attrs_define
class GetEntitlementResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetEntitlementResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetEntitlementResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetEntitlementResponse400Type(d.pop("type"))
        ...
        get_entitlement_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_entitlement_response_400.additional_properties = d
        return get_entitlement_response_400
