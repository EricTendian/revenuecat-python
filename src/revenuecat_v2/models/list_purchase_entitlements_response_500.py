...
from ..models.list_purchase_entitlements_response_500_type import ListPurchaseEntitlementsResponse500Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListPurchaseEntitlementsResponse500")


@_attrs_define
class ListPurchaseEntitlementsResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListPurchaseEntitlementsResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListPurchaseEntitlementsResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListPurchaseEntitlementsResponse500Type(d.pop("type"))
        ...
        list_purchase_entitlements_response_500 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_purchase_entitlements_response_500.additional_properties = d
        return list_purchase_entitlements_response_500
