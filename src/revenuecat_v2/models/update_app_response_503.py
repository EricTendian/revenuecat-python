...
from ..models.update_app_response_503_type import UpdateAppResponse503Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateAppResponse503")


@_attrs_define
class UpdateAppResponse503:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (UpdateAppResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: UpdateAppResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = UpdateAppResponse503Type(d.pop("type"))
        ...
        update_app_response_503.additional_properties = d
        return update_app_response_503
