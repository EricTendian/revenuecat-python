...
from ..models.get_authorized_subscription_management_url_response_503_type import (
    GetAuthorizedSubscriptionManagementUrlResponse503Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetAuthorizedSubscriptionManagementUrlResponse503")


@_attrs_define
class GetAuthorizedSubscriptionManagementUrlResponse503:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetAuthorizedSubscriptionManagementUrlResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetAuthorizedSubscriptionManagementUrlResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetAuthorizedSubscriptionManagementUrlResponse503Type(d.pop("type"))
        ...
        get_authorized_subscription_management_url_response_503 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_authorized_subscription_management_url_response_503.additional_properties = d
        return get_authorized_subscription_management_url_response_503
