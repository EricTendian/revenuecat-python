...
from ..models.refund_subscription_response_401_type import RefundSubscriptionResponse401Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="RefundSubscriptionResponse401")


@_attrs_define
class RefundSubscriptionResponse401:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (RefundSubscriptionResponse401Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: RefundSubscriptionResponse401Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = RefundSubscriptionResponse401Type(d.pop("type"))
        ...
        refund_subscription_response_401 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        refund_subscription_response_401.additional_properties = d
        return refund_subscription_response_401
