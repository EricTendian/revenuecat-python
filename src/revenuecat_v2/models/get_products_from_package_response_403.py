...
from ..models.get_products_from_package_response_403_type import GetProductsFromPackageResponse403Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetProductsFromPackageResponse403")


@_attrs_define
class GetProductsFromPackageResponse403:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetProductsFromPackageResponse403Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetProductsFromPackageResponse403Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetProductsFromPackageResponse403Type(d.pop("type"))
        ...
        get_products_from_package_response_403 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_products_from_package_response_403.additional_properties = d
        return get_products_from_package_response_403
