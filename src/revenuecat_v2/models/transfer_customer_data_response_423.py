...
from ..models.transfer_customer_data_response_423_type import TransferCustomerDataResponse423Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="TransferCustomerDataResponse423")


@_attrs_define
class TransferCustomerDataResponse423:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (TransferCustomerDataResponse423Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: TransferCustomerDataResponse423Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = TransferCustomerDataResponse423Type(d.pop("type"))
        ...
        transfer_customer_data_response_423 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        transfer_customer_data_response_423.additional_properties = d
        return transfer_customer_data_response_423
