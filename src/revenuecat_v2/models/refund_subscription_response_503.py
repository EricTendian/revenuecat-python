...
from ..models.refund_subscription_response_503_type import RefundSubscriptionResponse503Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="RefundSubscriptionResponse503")


@_attrs_define
class RefundSubscriptionResponse503:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (RefundSubscriptionResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: RefundSubscriptionResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = RefundSubscriptionResponse503Type(d.pop("type"))
        ...
        refund_subscription_response_503 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        refund_subscription_response_503.additional_properties = d
        return refund_subscription_response_503
