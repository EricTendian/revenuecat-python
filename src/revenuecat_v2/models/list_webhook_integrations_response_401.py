...
from ..models.list_webhook_integrations_response_401_type import ListWebhookIntegrationsResponse401Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListWebhookIntegrationsResponse401")


@_attrs_define
class ListWebhookIntegrationsResponse401:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListWebhookIntegrationsResponse401Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListWebhookIntegrationsResponse401Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListWebhookIntegrationsResponse401Type(d.pop("type"))
        ...
        list_webhook_integrations_response_401 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_webhook_integrations_response_401.additional_properties = d
        return list_webhook_integrations_response_401
