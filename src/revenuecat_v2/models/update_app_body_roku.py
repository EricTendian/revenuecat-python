...
T = TypeVar("T", bound="UpdateAppBodyRoku")


@_attrs_define
class UpdateAppBodyRoku:
    """Roku Channel Store type details. Should only be used when type is roku.

    Attributes:
        roku_api_key (None | str | Unset): Roku Pay API key provided on the Roku Pay Web Services page.
        roku_channel_id (None | str | Unset): Channel ID provided on the Roku Channel page.
        roku_channel_name (None | str | Unset): Channel name that is displayed on the Roku Channel page.
    """

    roku_api_key: None | str | Unset = UNSET
    roku_channel_id: None | str | Unset = UNSET
    roku_channel_name: None | str | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        roku_api_key: None | str | Unset
        if isinstance(self.roku_api_key, Unset):
            roku_api_key = UNSET
        else:
            roku_api_key = self.roku_api_key

        roku_channel_id: None | str | Unset
        if isinstance(self.roku_channel_id, Unset):
            roku_channel_id = UNSET
        else:
            roku_channel_id = self.roku_channel_id

        roku_channel_name: None | str | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_roku_api_key(data: object) -> None | str | Unset:
            if data is None:
                return data
        ...
        def _parse_roku_channel_id(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_roku_channel_name(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        update_app_body_roku = cls(
            roku_api_key=roku_api_key,
            roku_channel_id=roku_channel_id,
            roku_channel_name=roku_channel_name,
        )

        update_app_body_roku.additional_properties = d
        return update_app_body_roku
