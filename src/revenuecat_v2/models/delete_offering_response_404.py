...
from ..models.delete_offering_response_404_type import DeleteOfferingResponse404Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="DeleteOfferingResponse404")


@_attrs_define
class DeleteOfferingResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (DeleteOfferingResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: DeleteOfferingResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = DeleteOfferingResponse404Type(d.pop("type"))
        ...
        delete_offering_response_404 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        delete_offering_response_404.additional_properties = d
        return delete_offering_response_404
