...
from ..models.refund_play_store_subscription_transaction_response_422_type import (
    RefundPlayStoreSubscriptionTransactionResponse422Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RefundPlayStoreSubscriptionTransactionResponse422")


@_attrs_define
class RefundPlayStoreSubscriptionTransactionResponse422:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (RefundPlayStoreSubscriptionTransactionResponse422Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: RefundPlayStoreSubscriptionTransactionResponse422Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = RefundPlayStoreSubscriptionTransactionResponse422Type(d.pop("type"))
        ...
        refund_play_store_subscription_transaction_response_422 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        refund_play_store_subscription_transaction_response_422.additional_properties = d
        return refund_play_store_subscription_transaction_response_422
