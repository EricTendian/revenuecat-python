...
from ..models.list_subscription_entitlements_response_503_type import ListSubscriptionEntitlementsResponse503Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListSubscriptionEntitlementsResponse503")


@_attrs_define
class ListSubscriptionEntitlementsResponse503:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListSubscriptionEntitlementsResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListSubscriptionEntitlementsResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListSubscriptionEntitlementsResponse503Type(d.pop("type"))
        ...
        list_subscription_entitlements_response_503 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_subscription_entitlements_response_503.additional_properties = d
        return list_subscription_entitlements_response_503
