...
from ..models.list_customer_invoices_response_404_type import ListCustomerInvoicesResponse404Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListCustomerInvoicesResponse404")


@_attrs_define
class ListCustomerInvoicesResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListCustomerInvoicesResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListCustomerInvoicesResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListCustomerInvoicesResponse404Type(d.pop("type"))
        ...
        list_customer_invoices_response_404 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_customer_invoices_response_404.additional_properties = d
        return list_customer_invoices_response_404
