...
from ..models.revoke_customer_granted_entitlement_response_503_type import (
    RevokeCustomerGrantedEntitlementResponse503Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RevokeCustomerGrantedEntitlementResponse503")


@_attrs_define
class RevokeCustomerGrantedEntitlementResponse503:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (RevokeCustomerGrantedEntitlementResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: RevokeCustomerGrantedEntitlementResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = RevokeCustomerGrantedEntitlementResponse503Type(d.pop("type"))
        ...
        revoke_customer_granted_entitlement_response_503 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        revoke_customer_granted_entitlement_response_503.additional_properties = d
        return revoke_customer_granted_entitlement_response_503
