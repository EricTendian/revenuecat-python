...
from ..models.update_app_response_423_type import UpdateAppResponse423Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateAppResponse423")


@_attrs_define
class UpdateAppResponse423:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (UpdateAppResponse423Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: UpdateAppResponse423Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = UpdateAppResponse423Type(d.pop("type"))
        ...
        update_app_response_423.additional_properties = d
        return update_app_response_423
