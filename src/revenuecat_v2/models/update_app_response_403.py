...
from ..models.update_app_response_403_type import UpdateAppResponse403Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateAppResponse403")


@_attrs_define
class UpdateAppResponse403:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (UpdateAppResponse403Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: UpdateAppResponse403Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = UpdateAppResponse403Type(d.pop("type"))
        ...
        update_app_response_403.additional_properties = d
        return update_app_response_403
