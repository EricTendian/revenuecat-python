...
from ..models.detach_products_from_package_response_401_type import DetachProductsFromPackageResponse401Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="DetachProductsFromPackageResponse401")


@_attrs_define
class DetachProductsFromPackageResponse401:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (DetachProductsFromPackageResponse401Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: DetachProductsFromPackageResponse401Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = DetachProductsFromPackageResponse401Type(d.pop("type"))
        ...
        detach_products_from_package_response_401 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        detach_products_from_package_response_401.additional_properties = d
        return detach_products_from_package_response_401
