...
from ..models.list_packages_response_503_type import ListPackagesResponse503Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListPackagesResponse503")


@_attrs_define
class ListPackagesResponse503:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListPackagesResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListPackagesResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListPackagesResponse503Type(d.pop("type"))
        ...
        list_packages_response_503 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_packages_response_503.additional_properties = d
        return list_packages_response_503
