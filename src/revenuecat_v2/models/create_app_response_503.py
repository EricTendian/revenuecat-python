...
from ..models.create_app_response_503_type import CreateAppResponse503Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateAppResponse503")


@_attrs_define
class CreateAppResponse503:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (CreateAppResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: CreateAppResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CreateAppResponse503Type(d.pop("type"))
        ...
        create_app_response_503.additional_properties = d
        return create_app_response_503
