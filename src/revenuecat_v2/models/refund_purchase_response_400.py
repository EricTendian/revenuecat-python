...
from ..models.refund_purchase_response_400_type import RefundPurchaseResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="RefundPurchaseResponse400")


@_attrs_define
class RefundPurchaseResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (RefundPurchaseResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: RefundPurchaseResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = RefundPurchaseResponse400Type(d.pop("type"))
        ...
        refund_purchase_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        refund_purchase_response_400.additional_properties = d
        return refund_purchase_response_400
