...
from ..models.search_subscriptions_response_423_type import SearchSubscriptionsResponse423Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="SearchSubscriptionsResponse423")


@_attrs_define
class SearchSubscriptionsResponse423:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (SearchSubscriptionsResponse423Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: SearchSubscriptionsResponse423Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = SearchSubscriptionsResponse423Type(d.pop("type"))
        ...
        search_subscriptions_response_423 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        search_subscriptions_response_423.additional_properties = d
        return search_subscriptions_response_423
