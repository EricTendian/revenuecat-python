...
from ..models.get_entitlement_response_429_type import GetEntitlementResponse429Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetEntitlementResponse429")


@_attrs_define
class GetEntitlementResponse429:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetEntitlementResponse429Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetEntitlementResponse429Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetEntitlementResponse429Type(d.pop("type"))
        ...
        get_entitlement_response_429 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_entitlement_response_429.additional_properties = d
        return get_entitlement_response_429
