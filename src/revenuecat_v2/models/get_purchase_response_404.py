...
from ..models.get_purchase_response_404_type import GetPurchaseResponse404Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetPurchaseResponse404")


@_attrs_define
class GetPurchaseResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetPurchaseResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetPurchaseResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetPurchaseResponse404Type(d.pop("type"))
        ...
        get_purchase_response_404.additional_properties = d
        return get_purchase_response_404
