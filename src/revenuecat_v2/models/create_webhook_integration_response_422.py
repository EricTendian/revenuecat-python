...
from ..models.create_webhook_integration_response_422_type import CreateWebhookIntegrationResponse422Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateWebhookIntegrationResponse422")


@_attrs_define
class CreateWebhookIntegrationResponse422:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (CreateWebhookIntegrationResponse422Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: CreateWebhookIntegrationResponse422Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CreateWebhookIntegrationResponse422Type(d.pop("type"))
        ...
        create_webhook_integration_response_422 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        create_webhook_integration_response_422.additional_properties = d
        return create_webhook_integration_response_422
