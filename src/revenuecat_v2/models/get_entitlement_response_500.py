...
from ..models.get_entitlement_response_500_type import GetEntitlementResponse500Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetEntitlementResponse500")


@_attrs_define
class GetEntitlementResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetEntitlementResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetEntitlementResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetEntitlementResponse500Type(d.pop("type"))
        ...
        get_entitlement_response_500 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_entitlement_response_500.additional_properties = d
        return get_entitlement_response_500
