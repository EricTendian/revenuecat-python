...
from ..models.get_products_from_entitlement_response_404_type import GetProductsFromEntitlementResponse404Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetProductsFromEntitlementResponse404")


@_attrs_define
class GetProductsFromEntitlementResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetProductsFromEntitlementResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetProductsFromEntitlementResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetProductsFromEntitlementResponse404Type(d.pop("type"))
        ...
        get_products_from_entitlement_response_404 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_products_from_entitlement_response_404.additional_properties = d
        return get_products_from_entitlement_response_404
