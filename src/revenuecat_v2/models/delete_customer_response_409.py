...
from ..models.delete_customer_response_409_type import DeleteCustomerResponse409Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="DeleteCustomerResponse409")


@_attrs_define
class DeleteCustomerResponse409:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (DeleteCustomerResponse409Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: DeleteCustomerResponse409Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = DeleteCustomerResponse409Type(d.pop("type"))
        ...
        delete_customer_response_409 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        delete_customer_response_409.additional_properties = d
        return delete_customer_response_409
