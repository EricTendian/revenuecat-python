...
from ..models.cancel_subscription_response_422_type import CancelSubscriptionResponse422Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="CancelSubscriptionResponse422")


@_attrs_define
class CancelSubscriptionResponse422:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (CancelSubscriptionResponse422Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: CancelSubscriptionResponse422Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CancelSubscriptionResponse422Type(d.pop("type"))
        ...
        cancel_subscription_response_422 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        cancel_subscription_response_422.additional_properties = d
        return cancel_subscription_response_422
