...
from ..models.delete_entitlement_response_404_type import DeleteEntitlementResponse404Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="DeleteEntitlementResponse404")


@_attrs_define
class DeleteEntitlementResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (DeleteEntitlementResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: DeleteEntitlementResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = DeleteEntitlementResponse404Type(d.pop("type"))
        ...
        delete_entitlement_response_404 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        delete_entitlement_response_404.additional_properties = d
        return delete_entitlement_response_404
