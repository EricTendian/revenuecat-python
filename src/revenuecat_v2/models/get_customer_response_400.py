...
from ..models.get_customer_response_400_type import GetCustomerResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetCustomerResponse400")


@_attrs_define
class GetCustomerResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetCustomerResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetCustomerResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetCustomerResponse400Type(d.pop("type"))
        ...
        get_customer_response_400.additional_properties = d
        return get_customer_response_400
