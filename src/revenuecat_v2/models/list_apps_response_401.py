...
from ..models.list_apps_response_401_type import ListAppsResponse401Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListAppsResponse401")


@_attrs_define
class ListAppsResponse401:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListAppsResponse401Type): The error type Example: parameter_error.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListAppsResponse401Type(d.pop("type"))
        ...
        list_apps_response_401.additional_properties = d
        return list_apps_response_401
