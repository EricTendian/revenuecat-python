...
from ..models.detach_products_from_entitlement_response_500_type import DetachProductsFromEntitlementResponse500Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="DetachProductsFromEntitlementResponse500")


@_attrs_define
class DetachProductsFromEntitlementResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (DetachProductsFromEntitlementResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: DetachProductsFromEntitlementResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = DetachProductsFromEntitlementResponse500Type(d.pop("type"))
        ...
        detach_products_from_entitlement_response_500 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        detach_products_from_entitlement_response_500.additional_properties = d
        return detach_products_from_entitlement_response_500
