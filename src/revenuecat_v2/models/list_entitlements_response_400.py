...
from ..models.list_entitlements_response_400_type import ListEntitlementsResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListEntitlementsResponse400")


@_attrs_define
class ListEntitlementsResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListEntitlementsResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListEntitlementsResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListEntitlementsResponse400Type(d.pop("type"))
        ...
        list_entitlements_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_entitlements_response_400.additional_properties = d
        return list_entitlements_response_400
