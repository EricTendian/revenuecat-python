...
from ..models.set_customer_attributes_response_404_type import SetCustomerAttributesResponse404Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="SetCustomerAttributesResponse404")


@_attrs_define
class SetCustomerAttributesResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (SetCustomerAttributesResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: SetCustomerAttributesResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = SetCustomerAttributesResponse404Type(d.pop("type"))
        ...
        set_customer_attributes_response_404 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        set_customer_attributes_response_404.additional_properties = d
        return set_customer_attributes_response_404
