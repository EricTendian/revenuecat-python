...
from ..models.list_entitlements_response_404_type import ListEntitlementsResponse404Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListEntitlementsResponse404")


@_attrs_define
class ListEntitlementsResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListEntitlementsResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListEntitlementsResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListEntitlementsResponse404Type(d.pop("type"))
        ...
        list_entitlements_response_404 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_entitlements_response_404.additional_properties = d
        return list_entitlements_response_404
