...
from ..models.delete_product_response_423_type import DeleteProductResponse423Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="DeleteProductResponse423")


@_attrs_define
class DeleteProductResponse423:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (DeleteProductResponse423Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: DeleteProductResponse423Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = DeleteProductResponse423Type(d.pop("type"))
        ...
        delete_product_response_423 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        delete_product_response_423.additional_properties = d
        return delete_product_response_423
