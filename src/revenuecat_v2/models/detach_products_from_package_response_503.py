...
from ..models.detach_products_from_package_response_503_type import DetachProductsFromPackageResponse503Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="DetachProductsFromPackageResponse503")


@_attrs_define
class DetachProductsFromPackageResponse503:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (DetachProductsFromPackageResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: DetachProductsFromPackageResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = DetachProductsFromPackageResponse503Type(d.pop("type"))
        ...
        detach_products_from_package_response_503 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        detach_products_from_package_response_503.additional_properties = d
        return detach_products_from_package_response_503
