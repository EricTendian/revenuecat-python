...
from ..models.update_virtual_currencies_balance_response_500_type import UpdateVirtualCurrenciesBalanceResponse500Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateVirtualCurrenciesBalanceResponse500")


@_attrs_define
class UpdateVirtualCurrenciesBalanceResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (UpdateVirtualCurrenciesBalanceResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: UpdateVirtualCurrenciesBalanceResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = UpdateVirtualCurrenciesBalanceResponse500Type(d.pop("type"))
        ...
        update_virtual_currencies_balance_response_500 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        update_virtual_currencies_balance_response_500.additional_properties = d
        return update_virtual_currencies_balance_response_500
