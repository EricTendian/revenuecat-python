...
T = TypeVar("T", bound="CustomerAttributes")
...
class CustomerAttributes:
    ...
    Attributes:
        ...
        next_page (None | str): URL to access the next page of the customer's aliases. If not present / null, there is
            ...
            019a391603e2/attributes?starting_after=myCustomAttribute.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        customer_attributes.additional_properties = d
