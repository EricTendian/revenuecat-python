...
from ..models.list_virtual_currencies_balances_response_400_type import ListVirtualCurrenciesBalancesResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListVirtualCurrenciesBalancesResponse400")


@_attrs_define
class ListVirtualCurrenciesBalancesResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListVirtualCurrenciesBalancesResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListVirtualCurrenciesBalancesResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListVirtualCurrenciesBalancesResponse400Type(d.pop("type"))
        ...
        list_virtual_currencies_balances_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_virtual_currencies_balances_response_400.additional_properties = d
        return list_virtual_currencies_balances_response_400
