...
from ..models.update_app_response_422_type import UpdateAppResponse422Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateAppResponse422")


@_attrs_define
class UpdateAppResponse422:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (UpdateAppResponse422Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: UpdateAppResponse422Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = UpdateAppResponse422Type(d.pop("type"))
        ...
        update_app_response_422.additional_properties = d
        return update_app_response_422
