...
from ..models.list_virtual_currencies_balances_response_404_type import ListVirtualCurrenciesBalancesResponse404Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListVirtualCurrenciesBalancesResponse404")


@_attrs_define
class ListVirtualCurrenciesBalancesResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListVirtualCurrenciesBalancesResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListVirtualCurrenciesBalancesResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListVirtualCurrenciesBalancesResponse404Type(d.pop("type"))
        ...
        list_virtual_currencies_balances_response_404 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_virtual_currencies_balances_response_404.additional_properties = d
        return list_virtual_currencies_balances_response_404
