...
from ..models.create_product_response_409_type import CreateProductResponse409Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateProductResponse409")


@_attrs_define
class CreateProductResponse409:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (CreateProductResponse409Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: CreateProductResponse409Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CreateProductResponse409Type(d.pop("type"))
        ...
        create_product_response_409 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        create_product_response_409.additional_properties = d
        return create_product_response_409
