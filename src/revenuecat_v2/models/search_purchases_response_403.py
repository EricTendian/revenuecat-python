...
from ..models.search_purchases_response_403_type import SearchPurchasesResponse403Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="SearchPurchasesResponse403")


@_attrs_define
class SearchPurchasesResponse403:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (SearchPurchasesResponse403Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: SearchPurchasesResponse403Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = SearchPurchasesResponse403Type(d.pop("type"))
        ...
        search_purchases_response_403 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        search_purchases_response_403.additional_properties = d
        return search_purchases_response_403
