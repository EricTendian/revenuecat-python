...
from ..models.get_customer_response_500_type import GetCustomerResponse500Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetCustomerResponse500")


@_attrs_define
class GetCustomerResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetCustomerResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetCustomerResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetCustomerResponse500Type(d.pop("type"))
        ...
        get_customer_response_500.additional_properties = d
        return get_customer_response_500
