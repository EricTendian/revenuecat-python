...
from ..models.search_purchases_response_400_type import SearchPurchasesResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="SearchPurchasesResponse400")


@_attrs_define
class SearchPurchasesResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (SearchPurchasesResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: SearchPurchasesResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = SearchPurchasesResponse400Type(d.pop("type"))
        ...
        search_purchases_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        search_purchases_response_400.additional_properties = d
        return search_purchases_response_400
