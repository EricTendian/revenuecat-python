...
from ..models.update_app_response_500_type import UpdateAppResponse500Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateAppResponse500")


@_attrs_define
class UpdateAppResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (UpdateAppResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: UpdateAppResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = UpdateAppResponse500Type(d.pop("type"))
        ...
        update_app_response_500.additional_properties = d
        return update_app_response_500
