...
from ..models.get_app_response_423_type import GetAppResponse423Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetAppResponse423")


@_attrs_define
class GetAppResponse423:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetAppResponse423Type): The error type Example: parameter_error.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetAppResponse423Type(d.pop("type"))
        ...
        get_app_response_423.additional_properties = d
        return get_app_response_423
