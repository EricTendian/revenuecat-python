...
from ..models.list_apps_response_500_type import ListAppsResponse500Type
...
class ListAppsResponse500:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListAppsResponse500Type): The error type Example: parameter_error.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListAppsResponse500Type(d.pop("type"))
