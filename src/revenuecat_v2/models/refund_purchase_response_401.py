...
from ..models.refund_purchase_response_401_type import RefundPurchaseResponse401Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="RefundPurchaseResponse401")


@_attrs_define
class RefundPurchaseResponse401:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (RefundPurchaseResponse401Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: RefundPurchaseResponse401Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = RefundPurchaseResponse401Type(d.pop("type"))
        ...
        refund_purchase_response_401 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        refund_purchase_response_401.additional_properties = d
        return refund_purchase_response_401
