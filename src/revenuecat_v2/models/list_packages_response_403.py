...
from ..models.list_packages_response_403_type import ListPackagesResponse403Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListPackagesResponse403")


@_attrs_define
class ListPackagesResponse403:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListPackagesResponse403Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListPackagesResponse403Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListPackagesResponse403Type(d.pop("type"))
        ...
        list_packages_response_403 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_packages_response_403.additional_properties = d
        return list_packages_response_403
