...
from ..models.get_offering_response_503_type import GetOfferingResponse503Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetOfferingResponse503")


@_attrs_define
class GetOfferingResponse503:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetOfferingResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetOfferingResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetOfferingResponse503Type(d.pop("type"))
        ...
        get_offering_response_503.additional_properties = d
        return get_offering_response_503
