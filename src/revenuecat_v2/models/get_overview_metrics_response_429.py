...
from ..models.get_overview_metrics_response_429_type import GetOverviewMetricsResponse429Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetOverviewMetricsResponse429")


@_attrs_define
class GetOverviewMetricsResponse429:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetOverviewMetricsResponse429Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetOverviewMetricsResponse429Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetOverviewMetricsResponse429Type(d.pop("type"))
        ...
        get_overview_metrics_response_429 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_overview_metrics_response_429.additional_properties = d
        return get_overview_metrics_response_429
