...
from ..models.delete_webhook_integration_response_503_type import DeleteWebhookIntegrationResponse503Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="DeleteWebhookIntegrationResponse503")


@_attrs_define
class DeleteWebhookIntegrationResponse503:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (DeleteWebhookIntegrationResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: DeleteWebhookIntegrationResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = DeleteWebhookIntegrationResponse503Type(d.pop("type"))
        ...
        delete_webhook_integration_response_503 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        delete_webhook_integration_response_503.additional_properties = d
        return delete_webhook_integration_response_503
