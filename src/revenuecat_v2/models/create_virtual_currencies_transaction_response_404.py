...
from ..models.create_virtual_currencies_transaction_response_404_type import (
    CreateVirtualCurrenciesTransactionResponse404Type,
)
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateVirtualCurrenciesTransactionResponse404")


@_attrs_define
class CreateVirtualCurrenciesTransactionResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (CreateVirtualCurrenciesTransactionResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: CreateVirtualCurrenciesTransactionResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CreateVirtualCurrenciesTransactionResponse404Type(d.pop("type"))
        ...
        create_virtual_currencies_transaction_response_404 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        create_virtual_currencies_transaction_response_404.additional_properties = d
        return create_virtual_currencies_transaction_response_404
