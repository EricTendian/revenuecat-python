...
from ..models.get_play_store_subscription_transactions_response_429_type import (
    GetPlayStoreSubscriptionTransactionsResponse429Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetPlayStoreSubscriptionTransactionsResponse429")


@_attrs_define
class GetPlayStoreSubscriptionTransactionsResponse429:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetPlayStoreSubscriptionTransactionsResponse429Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetPlayStoreSubscriptionTransactionsResponse429Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetPlayStoreSubscriptionTransactionsResponse429Type(d.pop("type"))
        ...
        get_play_store_subscription_transactions_response_429 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_play_store_subscription_transactions_response_429.additional_properties = d
        return get_play_store_subscription_transactions_response_429
