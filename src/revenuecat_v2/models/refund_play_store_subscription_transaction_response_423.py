...
from ..models.refund_play_store_subscription_transaction_response_423_type import (
    RefundPlayStoreSubscriptionTransactionResponse423Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RefundPlayStoreSubscriptionTransactionResponse423")


@_attrs_define
class RefundPlayStoreSubscriptionTransactionResponse423:
    """
    Example:
        {'object': 'error', 'type': 'resource_locked_error', 'message': 'The resource is currently being modified by a
            concurrent request', 'retryable': True, 'doc_url': 'https://errors.rev.cat/resource-locked-error', 'backoff_ms':
            1000}

    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (RefundPlayStoreSubscriptionTransactionResponse423Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: RefundPlayStoreSubscriptionTransactionResponse423Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = RefundPlayStoreSubscriptionTransactionResponse423Type(d.pop("type"))
        ...
        refund_play_store_subscription_transaction_response_423 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        refund_play_store_subscription_transaction_response_423.additional_properties = d
        return refund_play_store_subscription_transaction_response_423
