...
from ..models.set_customer_attributes_response_403_type import SetCustomerAttributesResponse403Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="SetCustomerAttributesResponse403")


@_attrs_define
class SetCustomerAttributesResponse403:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (SetCustomerAttributesResponse403Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: SetCustomerAttributesResponse403Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = SetCustomerAttributesResponse403Type(d.pop("type"))
        ...
        set_customer_attributes_response_403 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        set_customer_attributes_response_403.additional_properties = d
        return set_customer_attributes_response_403
