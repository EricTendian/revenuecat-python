...
from ..models.get_customer_response_429_type import GetCustomerResponse429Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetCustomerResponse429")


@_attrs_define
class GetCustomerResponse429:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetCustomerResponse429Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetCustomerResponse429Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetCustomerResponse429Type(d.pop("type"))
        ...
        get_customer_response_429.additional_properties = d
        return get_customer_response_429
