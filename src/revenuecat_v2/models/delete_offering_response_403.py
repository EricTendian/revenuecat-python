...
from ..models.delete_offering_response_403_type import DeleteOfferingResponse403Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="DeleteOfferingResponse403")


@_attrs_define
class DeleteOfferingResponse403:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (DeleteOfferingResponse403Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: DeleteOfferingResponse403Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = DeleteOfferingResponse403Type(d.pop("type"))
        ...
        delete_offering_response_403 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        delete_offering_response_403.additional_properties = d
        return delete_offering_response_403
