...
from ..models.search_purchases_response_404_type import SearchPurchasesResponse404Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="SearchPurchasesResponse404")


@_attrs_define
class SearchPurchasesResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (SearchPurchasesResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: SearchPurchasesResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = SearchPurchasesResponse404Type(d.pop("type"))
        ...
        search_purchases_response_404 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        search_purchases_response_404.additional_properties = d
        return search_purchases_response_404
