...
from ..models.list_virtual_currencies_balances_response_503_type import ListVirtualCurrenciesBalancesResponse503Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListVirtualCurrenciesBalancesResponse503")


@_attrs_define
class ListVirtualCurrenciesBalancesResponse503:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListVirtualCurrenciesBalancesResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListVirtualCurrenciesBalancesResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListVirtualCurrenciesBalancesResponse503Type(d.pop("type"))
        ...
        list_virtual_currencies_balances_response_503 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_virtual_currencies_balances_response_503.additional_properties = d
        return list_virtual_currencies_balances_response_503
