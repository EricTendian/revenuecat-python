...
from ..models.get_product_response_500_type import GetProductResponse500Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetProductResponse500")


@_attrs_define
class GetProductResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetProductResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetProductResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetProductResponse500Type(d.pop("type"))
        ...
        get_product_response_500.additional_properties = d
        return get_product_response_500
