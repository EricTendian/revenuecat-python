...
from ..models.revoke_customer_granted_entitlement_response_429_type import (
    RevokeCustomerGrantedEntitlementResponse429Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RevokeCustomerGrantedEntitlementResponse429")


@_attrs_define
class RevokeCustomerGrantedEntitlementResponse429:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (RevokeCustomerGrantedEntitlementResponse429Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: RevokeCustomerGrantedEntitlementResponse429Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = RevokeCustomerGrantedEntitlementResponse429Type(d.pop("type"))
        ...
        revoke_customer_granted_entitlement_response_429 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        revoke_customer_granted_entitlement_response_429.additional_properties = d
        return revoke_customer_granted_entitlement_response_429
