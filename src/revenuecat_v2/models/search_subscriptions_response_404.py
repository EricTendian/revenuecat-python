...
from ..models.search_subscriptions_response_404_type import SearchSubscriptionsResponse404Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="SearchSubscriptionsResponse404")


@_attrs_define
class SearchSubscriptionsResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (SearchSubscriptionsResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: SearchSubscriptionsResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = SearchSubscriptionsResponse404Type(d.pop("type"))
        ...
        search_subscriptions_response_404 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        search_subscriptions_response_404.additional_properties = d
        return search_subscriptions_response_404
