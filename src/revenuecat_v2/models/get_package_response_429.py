...
from ..models.get_package_response_429_type import GetPackageResponse429Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetPackageResponse429")


@_attrs_define
class GetPackageResponse429:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetPackageResponse429Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetPackageResponse429Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetPackageResponse429Type(d.pop("type"))
        ...
        get_package_response_429.additional_properties = d
        return get_package_response_429
