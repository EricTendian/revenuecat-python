...
from ..models.list_projects_response_401_type import ListProjectsResponse401Type
...
class ListProjectsResponse401:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListProjectsResponse401Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListProjectsResponse401Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListProjectsResponse401Type(d.pop("type"))
