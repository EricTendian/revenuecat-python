...
from ..models.update_entitlement_response_401_type import UpdateEntitlementResponse401Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateEntitlementResponse401")


@_attrs_define
class UpdateEntitlementResponse401:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (UpdateEntitlementResponse401Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: UpdateEntitlementResponse401Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = UpdateEntitlementResponse401Type(d.pop("type"))
        ...
        update_entitlement_response_401 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        update_entitlement_response_401.additional_properties = d
        return update_entitlement_response_401
