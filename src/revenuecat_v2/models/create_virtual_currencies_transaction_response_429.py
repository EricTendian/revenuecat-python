...
from ..models.create_virtual_currencies_transaction_response_429_type import (
    CreateVirtualCurrenciesTransactionResponse429Type,
)
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateVirtualCurrenciesTransactionResponse429")


@_attrs_define
class CreateVirtualCurrenciesTransactionResponse429:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (CreateVirtualCurrenciesTransactionResponse429Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: CreateVirtualCurrenciesTransactionResponse429Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CreateVirtualCurrenciesTransactionResponse429Type(d.pop("type"))
        ...
        create_virtual_currencies_transaction_response_429 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        create_virtual_currencies_transaction_response_429.additional_properties = d
        return create_virtual_currencies_transaction_response_429
