...
from ..models.grant_customer_entitlement_response_409_type import GrantCustomerEntitlementResponse409Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GrantCustomerEntitlementResponse409")


@_attrs_define
class GrantCustomerEntitlementResponse409:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GrantCustomerEntitlementResponse409Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GrantCustomerEntitlementResponse409Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GrantCustomerEntitlementResponse409Type(d.pop("type"))
        ...
        grant_customer_entitlement_response_409 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        grant_customer_entitlement_response_409.additional_properties = d
        return grant_customer_entitlement_response_409
