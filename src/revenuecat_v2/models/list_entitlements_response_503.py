...
from ..models.list_entitlements_response_503_type import ListEntitlementsResponse503Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListEntitlementsResponse503")


@_attrs_define
class ListEntitlementsResponse503:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListEntitlementsResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListEntitlementsResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListEntitlementsResponse503Type(d.pop("type"))
        ...
        list_entitlements_response_503 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_entitlements_response_503.additional_properties = d
        return list_entitlements_response_503
