...
from ..models.attach_products_to_entitlement_response_400_type import AttachProductsToEntitlementResponse400Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="AttachProductsToEntitlementResponse400")


@_attrs_define
class AttachProductsToEntitlementResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (AttachProductsToEntitlementResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: AttachProductsToEntitlementResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = AttachProductsToEntitlementResponse400Type(d.pop("type"))
        ...
        attach_products_to_entitlement_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        attach_products_to_entitlement_response_400.additional_properties = d
        return attach_products_to_entitlement_response_400
