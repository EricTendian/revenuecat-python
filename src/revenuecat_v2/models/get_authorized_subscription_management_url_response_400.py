...
from ..models.get_authorized_subscription_management_url_response_400_type import (
    GetAuthorizedSubscriptionManagementUrlResponse400Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetAuthorizedSubscriptionManagementUrlResponse400")


@_attrs_define
class GetAuthorizedSubscriptionManagementUrlResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetAuthorizedSubscriptionManagementUrlResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetAuthorizedSubscriptionManagementUrlResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetAuthorizedSubscriptionManagementUrlResponse400Type(d.pop("type"))
        ...
        get_authorized_subscription_management_url_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_authorized_subscription_management_url_response_400.additional_properties = d
        return get_authorized_subscription_management_url_response_400
