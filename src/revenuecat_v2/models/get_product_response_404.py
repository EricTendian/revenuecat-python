...
from ..models.get_product_response_404_type import GetProductResponse404Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetProductResponse404")


@_attrs_define
class GetProductResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetProductResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetProductResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetProductResponse404Type(d.pop("type"))
        ...
        get_product_response_404.additional_properties = d
        return get_product_response_404
