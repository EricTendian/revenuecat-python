...
from ..models.search_purchases_response_423_type import SearchPurchasesResponse423Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="SearchPurchasesResponse423")


@_attrs_define
class SearchPurchasesResponse423:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (SearchPurchasesResponse423Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: SearchPurchasesResponse423Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = SearchPurchasesResponse423Type(d.pop("type"))
        ...
        search_purchases_response_423 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        search_purchases_response_423.additional_properties = d
        return search_purchases_response_423
