...
from ..models.attach_products_to_package_response_500_type import AttachProductsToPackageResponse500Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="AttachProductsToPackageResponse500")


@_attrs_define
class AttachProductsToPackageResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (AttachProductsToPackageResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: AttachProductsToPackageResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = AttachProductsToPackageResponse500Type(d.pop("type"))
        ...
        attach_products_to_package_response_500 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        attach_products_to_package_response_500.additional_properties = d
        return attach_products_to_package_response_500
