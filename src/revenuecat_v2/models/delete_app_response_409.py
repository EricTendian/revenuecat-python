...
from ..models.delete_app_response_409_type import DeleteAppResponse409Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="DeleteAppResponse409")


@_attrs_define
class DeleteAppResponse409:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (DeleteAppResponse409Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: DeleteAppResponse409Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = DeleteAppResponse409Type(d.pop("type"))
        ...
        delete_app_response_409.additional_properties = d
        return delete_app_response_409
