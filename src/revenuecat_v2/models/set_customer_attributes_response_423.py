...
from ..models.set_customer_attributes_response_423_type import SetCustomerAttributesResponse423Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="SetCustomerAttributesResponse423")


@_attrs_define
class SetCustomerAttributesResponse423:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (SetCustomerAttributesResponse423Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: SetCustomerAttributesResponse423Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = SetCustomerAttributesResponse423Type(d.pop("type"))
        ...
        set_customer_attributes_response_423 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        set_customer_attributes_response_423.additional_properties = d
        return set_customer_attributes_response_423
