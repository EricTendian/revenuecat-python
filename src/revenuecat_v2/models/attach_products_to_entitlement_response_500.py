...
from ..models.attach_products_to_entitlement_response_500_type import AttachProductsToEntitlementResponse500Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="AttachProductsToEntitlementResponse500")


@_attrs_define
class AttachProductsToEntitlementResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (AttachProductsToEntitlementResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: AttachProductsToEntitlementResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = AttachProductsToEntitlementResponse500Type(d.pop("type"))
        ...
        attach_products_to_entitlement_response_500 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        attach_products_to_entitlement_response_500.additional_properties = d
        return attach_products_to_entitlement_response_500
