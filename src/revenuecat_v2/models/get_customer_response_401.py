...
from ..models.get_customer_response_401_type import GetCustomerResponse401Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetCustomerResponse401")


@_attrs_define
class GetCustomerResponse401:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetCustomerResponse401Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetCustomerResponse401Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetCustomerResponse401Type(d.pop("type"))
        ...
        get_customer_response_401.additional_properties = d
        return get_customer_response_401
