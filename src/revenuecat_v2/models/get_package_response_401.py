...
from ..models.get_package_response_401_type import GetPackageResponse401Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetPackageResponse401")


@_attrs_define
class GetPackageResponse401:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetPackageResponse401Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetPackageResponse401Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetPackageResponse401Type(d.pop("type"))
        ...
        get_package_response_401.additional_properties = d
        return get_package_response_401
