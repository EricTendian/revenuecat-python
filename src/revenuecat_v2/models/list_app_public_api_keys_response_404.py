...
from ..models.list_app_public_api_keys_response_404_type import ListAppPublicApiKeysResponse404Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListAppPublicApiKeysResponse404")


@_attrs_define
class ListAppPublicApiKeysResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListAppPublicApiKeysResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListAppPublicApiKeysResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListAppPublicApiKeysResponse404Type(d.pop("type"))
        ...
        list_app_public_api_keys_response_404 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_app_public_api_keys_response_404.additional_properties = d
        return list_app_public_api_keys_response_404
