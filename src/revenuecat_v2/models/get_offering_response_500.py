...
from ..models.get_offering_response_500_type import GetOfferingResponse500Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetOfferingResponse500")


@_attrs_define
class GetOfferingResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetOfferingResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetOfferingResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetOfferingResponse500Type(d.pop("type"))
        ...
        get_offering_response_500.additional_properties = d
        return get_offering_response_500
