...
from ..models.list_purchase_entitlements_response_423_type import ListPurchaseEntitlementsResponse423Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListPurchaseEntitlementsResponse423")


@_attrs_define
class ListPurchaseEntitlementsResponse423:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListPurchaseEntitlementsResponse423Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListPurchaseEntitlementsResponse423Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListPurchaseEntitlementsResponse423Type(d.pop("type"))
        ...
        list_purchase_entitlements_response_423 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_purchase_entitlements_response_423.additional_properties = d
        return list_purchase_entitlements_response_423
