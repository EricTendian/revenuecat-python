...
from ..models.get_purchase_response_503_type import GetPurchaseResponse503Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetPurchaseResponse503")


@_attrs_define
class GetPurchaseResponse503:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetPurchaseResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetPurchaseResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetPurchaseResponse503Type(d.pop("type"))
        ...
        get_purchase_response_503.additional_properties = d
        return get_purchase_response_503
