...
from ..models.create_app_response_423_type import CreateAppResponse423Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateAppResponse423")


@_attrs_define
class CreateAppResponse423:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (CreateAppResponse423Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: CreateAppResponse423Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CreateAppResponse423Type(d.pop("type"))
        ...
        create_app_response_423.additional_properties = d
        return create_app_response_423
