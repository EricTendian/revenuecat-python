...
from ..models.create_project_response_500_type import CreateProjectResponse500Type
...
class CreateProjectResponse500:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (CreateProjectResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: CreateProjectResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CreateProjectResponse500Type(d.pop("type"))
