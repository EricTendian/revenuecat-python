...
from ..models.refund_subscription_response_400_type import RefundSubscriptionResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="RefundSubscriptionResponse400")


@_attrs_define
class RefundSubscriptionResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (RefundSubscriptionResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: RefundSubscriptionResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = RefundSubscriptionResponse400Type(d.pop("type"))
        ...
        refund_subscription_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        refund_subscription_response_400.additional_properties = d
        return refund_subscription_response_400
