...
from ..models.list_apps_response_423_type import ListAppsResponse423Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListAppsResponse423")


@_attrs_define
class ListAppsResponse423:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListAppsResponse423Type): The error type Example: parameter_error.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListAppsResponse423Type(d.pop("type"))
        ...
        list_apps_response_423.additional_properties = d
        return list_apps_response_423
