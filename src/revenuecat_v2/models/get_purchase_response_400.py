...
from ..models.get_purchase_response_400_type import GetPurchaseResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetPurchaseResponse400")


@_attrs_define
class GetPurchaseResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetPurchaseResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetPurchaseResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetPurchaseResponse400Type(d.pop("type"))
        ...
        get_purchase_response_400.additional_properties = d
        return get_purchase_response_400
