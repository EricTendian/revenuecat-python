...
from ..models.get_customer_response_423_type import GetCustomerResponse423Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetCustomerResponse423")


@_attrs_define
class GetCustomerResponse423:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetCustomerResponse423Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetCustomerResponse423Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetCustomerResponse423Type(d.pop("type"))
        ...
        get_customer_response_423.additional_properties = d
        return get_customer_response_423
