...
from ..models.get_subscription_response_400_type import GetSubscriptionResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetSubscriptionResponse400")


@_attrs_define
class GetSubscriptionResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetSubscriptionResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetSubscriptionResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetSubscriptionResponse400Type(d.pop("type"))
        ...
        get_subscription_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_subscription_response_400.additional_properties = d
