...
from ..models.refund_purchase_response_404_type import RefundPurchaseResponse404Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="RefundPurchaseResponse404")


@_attrs_define
class RefundPurchaseResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (RefundPurchaseResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: RefundPurchaseResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = RefundPurchaseResponse404Type(d.pop("type"))
        ...
        refund_purchase_response_404 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        refund_purchase_response_404.additional_properties = d
        return refund_purchase_response_404
