...
from ..models.refund_purchase_response_500_type import RefundPurchaseResponse500Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="RefundPurchaseResponse500")


@_attrs_define
class RefundPurchaseResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (RefundPurchaseResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: RefundPurchaseResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = RefundPurchaseResponse500Type(d.pop("type"))
        ...
        refund_purchase_response_500 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        refund_purchase_response_500.additional_properties = d
        return refund_purchase_response_500
