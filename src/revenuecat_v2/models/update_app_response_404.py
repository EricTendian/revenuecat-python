...
from ..models.update_app_response_404_type import UpdateAppResponse404Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateAppResponse404")


@_attrs_define
class UpdateAppResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (UpdateAppResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: UpdateAppResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = UpdateAppResponse404Type(d.pop("type"))
        ...
        update_app_response_404.additional_properties = d
        return update_app_response_404
