...
from ..models.cancel_subscription_response_423_type import CancelSubscriptionResponse423Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="CancelSubscriptionResponse423")


@_attrs_define
class CancelSubscriptionResponse423:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (CancelSubscriptionResponse423Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: CancelSubscriptionResponse423Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CancelSubscriptionResponse423Type(d.pop("type"))
        ...
        cancel_subscription_response_423 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        cancel_subscription_response_423.additional_properties = d
        return cancel_subscription_response_423
