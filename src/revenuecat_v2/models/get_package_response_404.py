...
from ..models.get_package_response_404_type import GetPackageResponse404Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetPackageResponse404")


@_attrs_define
class GetPackageResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetPackageResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetPackageResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetPackageResponse404Type(d.pop("type"))
        ...
        get_package_response_404.additional_properties = d
        return get_package_response_404
