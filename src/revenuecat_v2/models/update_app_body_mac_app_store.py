...
T = TypeVar("T", bound="UpdateAppBodyMacAppStore")


@_attrs_define
class UpdateAppBodyMacAppStore:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_app_body_mac_app_store = cls(
            bundle_id=bundle_id,
            shared_secret=shared_secret,
        )

        update_app_body_mac_app_store.additional_properties = d
        return update_app_body_mac_app_store
