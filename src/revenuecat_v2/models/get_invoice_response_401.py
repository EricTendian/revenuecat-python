...
from ..models.get_invoice_response_401_type import GetInvoiceResponse401Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetInvoiceResponse401")


@_attrs_define
class GetInvoiceResponse401:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetInvoiceResponse401Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetInvoiceResponse401Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetInvoiceResponse401Type(d.pop("type"))
        ...
        get_invoice_response_401.additional_properties = d
        return get_invoice_response_401
