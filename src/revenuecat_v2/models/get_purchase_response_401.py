...
from ..models.get_purchase_response_401_type import GetPurchaseResponse401Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetPurchaseResponse401")


@_attrs_define
class GetPurchaseResponse401:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetPurchaseResponse401Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetPurchaseResponse401Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetPurchaseResponse401Type(d.pop("type"))
        ...
        get_purchase_response_401.additional_properties = d
        return get_purchase_response_401
