...
from ..models.transfer_customer_data_response_404_type import TransferCustomerDataResponse404Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="TransferCustomerDataResponse404")


@_attrs_define
class TransferCustomerDataResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (TransferCustomerDataResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: TransferCustomerDataResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = TransferCustomerDataResponse404Type(d.pop("type"))
        ...
        transfer_customer_data_response_404 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        transfer_customer_data_response_404.additional_properties = d
        return transfer_customer_data_response_404
