...
from ..models.get_authorized_subscription_management_url_response_429_type import (
    GetAuthorizedSubscriptionManagementUrlResponse429Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetAuthorizedSubscriptionManagementUrlResponse429")


@_attrs_define
class GetAuthorizedSubscriptionManagementUrlResponse429:
    """
    Example:
        {'object': 'error', 'type': 'rate_limit_error', 'message': 'Rate limit exceeded', 'retryable': True, 'doc_url':
            'https://errors.rev.cat/rate-limit-error', 'backoff_ms': 1000}

    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetAuthorizedSubscriptionManagementUrlResponse429Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetAuthorizedSubscriptionManagementUrlResponse429Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetAuthorizedSubscriptionManagementUrlResponse429Type(d.pop("type"))
        ...
        get_authorized_subscription_management_url_response_429 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_authorized_subscription_management_url_response_429.additional_properties = d
        return get_authorized_subscription_management_url_response_429
