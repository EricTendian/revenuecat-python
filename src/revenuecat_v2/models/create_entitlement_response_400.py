...
from ..models.create_entitlement_response_400_type import CreateEntitlementResponse400Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateEntitlementResponse400")


@_attrs_define
class CreateEntitlementResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (CreateEntitlementResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: CreateEntitlementResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CreateEntitlementResponse400Type(d.pop("type"))
        ...
        create_entitlement_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        create_entitlement_response_400.additional_properties = d
        return create_entitlement_response_400
