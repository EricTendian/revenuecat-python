...
from ..models.get_subscription_response_403_type import GetSubscriptionResponse403Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetSubscriptionResponse403")


@_attrs_define
class GetSubscriptionResponse403:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetSubscriptionResponse403Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetSubscriptionResponse403Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetSubscriptionResponse403Type(d.pop("type"))
        ...
        get_subscription_response_403 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_subscription_response_403.additional_properties = d
        return get_subscription_response_403
