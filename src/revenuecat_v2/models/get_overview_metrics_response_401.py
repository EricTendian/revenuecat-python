...
from ..models.get_overview_metrics_response_401_type import GetOverviewMetricsResponse401Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetOverviewMetricsResponse401")


@_attrs_define
class GetOverviewMetricsResponse401:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetOverviewMetricsResponse401Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetOverviewMetricsResponse401Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetOverviewMetricsResponse401Type(d.pop("type"))
        ...
        get_overview_metrics_response_401 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_overview_metrics_response_401.additional_properties = d
        return get_overview_metrics_response_401
