...
from ..models.update_offering_response_403_type import UpdateOfferingResponse403Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateOfferingResponse403")


@_attrs_define
class UpdateOfferingResponse403:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (UpdateOfferingResponse403Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: UpdateOfferingResponse403Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = UpdateOfferingResponse403Type(d.pop("type"))
        ...
        update_offering_response_403 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        update_offering_response_403.additional_properties = d
        return update_offering_response_403
