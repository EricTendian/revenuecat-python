...
from ..models.list_purchase_entitlements_response_403_type import ListPurchaseEntitlementsResponse403Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListPurchaseEntitlementsResponse403")


@_attrs_define
class ListPurchaseEntitlementsResponse403:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListPurchaseEntitlementsResponse403Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListPurchaseEntitlementsResponse403Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListPurchaseEntitlementsResponse403Type(d.pop("type"))
        ...
        list_purchase_entitlements_response_403 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_purchase_entitlements_response_403.additional_properties = d
        return list_purchase_entitlements_response_403
