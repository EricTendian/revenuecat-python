...
from ..models.get_overview_metrics_response_404_type import GetOverviewMetricsResponse404Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetOverviewMetricsResponse404")


@_attrs_define
class GetOverviewMetricsResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetOverviewMetricsResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetOverviewMetricsResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetOverviewMetricsResponse404Type(d.pop("type"))
        ...
        get_overview_metrics_response_404 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_overview_metrics_response_404.additional_properties = d
        return get_overview_metrics_response_404
