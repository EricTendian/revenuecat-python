...
from ..models.get_offering_response_403_type import GetOfferingResponse403Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetOfferingResponse403")


@_attrs_define
class GetOfferingResponse403:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetOfferingResponse403Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetOfferingResponse403Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetOfferingResponse403Type(d.pop("type"))
        ...
        get_offering_response_403.additional_properties = d
        return get_offering_response_403
