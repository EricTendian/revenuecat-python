...
from ..models.get_package_response_423_type import GetPackageResponse423Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetPackageResponse423")


@_attrs_define
class GetPackageResponse423:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetPackageResponse423Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetPackageResponse423Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetPackageResponse423Type(d.pop("type"))
        ...
        get_package_response_423.additional_properties = d
        return get_package_response_423
