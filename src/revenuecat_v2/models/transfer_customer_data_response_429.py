...
from ..models.transfer_customer_data_response_429_type import TransferCustomerDataResponse429Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="TransferCustomerDataResponse429")


@_attrs_define
class TransferCustomerDataResponse429:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (TransferCustomerDataResponse429Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: TransferCustomerDataResponse429Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = TransferCustomerDataResponse429Type(d.pop("type"))
        ...
        transfer_customer_data_response_429 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        transfer_customer_data_response_429.additional_properties = d
        return transfer_customer_data_response_429
