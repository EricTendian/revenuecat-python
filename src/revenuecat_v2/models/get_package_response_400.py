...
from ..models.get_package_response_400_type import GetPackageResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetPackageResponse400")


@_attrs_define
class GetPackageResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetPackageResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetPackageResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetPackageResponse400Type(d.pop("type"))
        ...
        get_package_response_400.additional_properties = d
        return get_package_response_400
