...
from ..models.list_customer_aliases_response_503_type import ListCustomerAliasesResponse503Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListCustomerAliasesResponse503")


@_attrs_define
class ListCustomerAliasesResponse503:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListCustomerAliasesResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListCustomerAliasesResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListCustomerAliasesResponse503Type(d.pop("type"))
        ...
        list_customer_aliases_response_503 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_customer_aliases_response_503.additional_properties = d
        return list_customer_aliases_response_503
