...
from ..models.get_product_response_401_type import GetProductResponse401Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetProductResponse401")


@_attrs_define
class GetProductResponse401:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetProductResponse401Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetProductResponse401Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetProductResponse401Type(d.pop("type"))
        ...
        get_product_response_401.additional_properties = d
        return get_product_response_401
