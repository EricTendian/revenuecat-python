...
from ..models.list_packages_response_404_type import ListPackagesResponse404Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListPackagesResponse404")


@_attrs_define
class ListPackagesResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListPackagesResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListPackagesResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListPackagesResponse404Type(d.pop("type"))
        ...
        list_packages_response_404 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_packages_response_404.additional_properties = d
        return list_packages_response_404
