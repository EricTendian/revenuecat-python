...
from ..models.search_subscriptions_response_400_type import SearchSubscriptionsResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="SearchSubscriptionsResponse400")


@_attrs_define
class SearchSubscriptionsResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (SearchSubscriptionsResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: SearchSubscriptionsResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = SearchSubscriptionsResponse400Type(d.pop("type"))
        ...
        search_subscriptions_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        search_subscriptions_response_400.additional_properties = d
        return search_subscriptions_response_400
