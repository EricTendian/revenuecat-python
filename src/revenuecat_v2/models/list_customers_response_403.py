...
from ..models.list_customers_response_403_type import ListCustomersResponse403Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListCustomersResponse403")


@_attrs_define
class ListCustomersResponse403:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListCustomersResponse403Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListCustomersResponse403Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListCustomersResponse403Type(d.pop("type"))
        ...
        list_customers_response_403 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_customers_response_403.additional_properties = d
        return list_customers_response_403
