...
from ..models.grant_customer_entitlement_response_400_type import GrantCustomerEntitlementResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GrantCustomerEntitlementResponse400")


@_attrs_define
class GrantCustomerEntitlementResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GrantCustomerEntitlementResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GrantCustomerEntitlementResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GrantCustomerEntitlementResponse400Type(d.pop("type"))
        ...
        grant_customer_entitlement_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        grant_customer_entitlement_response_400.additional_properties = d
        return grant_customer_entitlement_response_400
