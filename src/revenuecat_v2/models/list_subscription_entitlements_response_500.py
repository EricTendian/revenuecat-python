...
from ..models.list_subscription_entitlements_response_500_type import ListSubscriptionEntitlementsResponse500Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListSubscriptionEntitlementsResponse500")


@_attrs_define
class ListSubscriptionEntitlementsResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListSubscriptionEntitlementsResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListSubscriptionEntitlementsResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListSubscriptionEntitlementsResponse500Type(d.pop("type"))
        ...
        list_subscription_entitlements_response_500 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_subscription_entitlements_response_500.additional_properties = d
        return list_subscription_entitlements_response_500
