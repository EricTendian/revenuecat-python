...
from ..models.get_product_response_503_type import GetProductResponse503Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetProductResponse503")


@_attrs_define
class GetProductResponse503:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetProductResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetProductResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetProductResponse503Type(d.pop("type"))
        ...
        get_product_response_503.additional_properties = d
        return get_product_response_503
