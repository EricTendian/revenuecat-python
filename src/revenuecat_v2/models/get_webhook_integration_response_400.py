...
from ..models.get_webhook_integration_response_400_type import GetWebhookIntegrationResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetWebhookIntegrationResponse400")


@_attrs_define
class GetWebhookIntegrationResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetWebhookIntegrationResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetWebhookIntegrationResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetWebhookIntegrationResponse400Type(d.pop("type"))
        ...
        get_webhook_integration_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_webhook_integration_response_400.additional_properties = d
        return get_webhook_integration_response_400
