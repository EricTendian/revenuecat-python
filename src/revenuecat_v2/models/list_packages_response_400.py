...
from ..models.list_packages_response_400_type import ListPackagesResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListPackagesResponse400")


@_attrs_define
class ListPackagesResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListPackagesResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListPackagesResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListPackagesResponse400Type(d.pop("type"))
        ...
        list_packages_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_packages_response_400.additional_properties = d
        return list_packages_response_400
