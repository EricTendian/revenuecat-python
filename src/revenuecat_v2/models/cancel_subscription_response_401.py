...
from ..models.cancel_subscription_response_401_type import CancelSubscriptionResponse401Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="CancelSubscriptionResponse401")


@_attrs_define
class CancelSubscriptionResponse401:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (CancelSubscriptionResponse401Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: CancelSubscriptionResponse401Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CancelSubscriptionResponse401Type(d.pop("type"))
        ...
        cancel_subscription_response_401 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        cancel_subscription_response_401.additional_properties = d
        return cancel_subscription_response_401
