...
from ..models.get_customer_response_404_type import GetCustomerResponse404Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetCustomerResponse404")


@_attrs_define
class GetCustomerResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetCustomerResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetCustomerResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetCustomerResponse404Type(d.pop("type"))
        ...
        get_customer_response_404.additional_properties = d
        return get_customer_response_404
