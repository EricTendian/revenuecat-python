...
from ..models.create_packages_response_401_type import CreatePackagesResponse401Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreatePackagesResponse401")


@_attrs_define
class CreatePackagesResponse401:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (CreatePackagesResponse401Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: CreatePackagesResponse401Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CreatePackagesResponse401Type(d.pop("type"))
        ...
        create_packages_response_401 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        create_packages_response_401.additional_properties = d
        return create_packages_response_401
