...
from ..models.delete_app_response_422_type import DeleteAppResponse422Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="DeleteAppResponse422")


@_attrs_define
class DeleteAppResponse422:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (DeleteAppResponse422Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: DeleteAppResponse422Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = DeleteAppResponse422Type(d.pop("type"))
        ...
        delete_app_response_422.additional_properties = d
        return delete_app_response_422
