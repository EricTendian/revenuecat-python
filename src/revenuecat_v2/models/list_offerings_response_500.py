...
from ..models.list_offerings_response_500_type import ListOfferingsResponse500Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListOfferingsResponse500")


@_attrs_define
class ListOfferingsResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListOfferingsResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListOfferingsResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListOfferingsResponse500Type(d.pop("type"))
        ...
        list_offerings_response_500 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_offerings_response_500.additional_properties = d
        return list_offerings_response_500
