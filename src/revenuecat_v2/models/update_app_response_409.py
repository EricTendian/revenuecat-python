...
from ..models.update_app_response_409_type import UpdateAppResponse409Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateAppResponse409")


@_attrs_define
class UpdateAppResponse409:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (UpdateAppResponse409Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: UpdateAppResponse409Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = UpdateAppResponse409Type(d.pop("type"))
        ...
        update_app_response_409.additional_properties = d
        return update_app_response_409
