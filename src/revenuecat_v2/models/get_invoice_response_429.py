...
from ..models.get_invoice_response_429_type import GetInvoiceResponse429Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetInvoiceResponse429")


@_attrs_define
class GetInvoiceResponse429:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetInvoiceResponse429Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetInvoiceResponse429Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetInvoiceResponse429Type(d.pop("type"))
        ...
        get_invoice_response_429.additional_properties = d
        return get_invoice_response_429
