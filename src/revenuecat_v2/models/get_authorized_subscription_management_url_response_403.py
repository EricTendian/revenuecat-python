...
from ..models.get_authorized_subscription_management_url_response_403_type import (
    GetAuthorizedSubscriptionManagementUrlResponse403Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetAuthorizedSubscriptionManagementUrlResponse403")


@_attrs_define
class GetAuthorizedSubscriptionManagementUrlResponse403:
    """
    Example:
        {'object': 'error', 'type': 'authorization_error', 'message': "You're not authorized to access this resource",
            'retryable': False, 'doc_url': 'https://errors.rev.cat/authorization-error'}

    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetAuthorizedSubscriptionManagementUrlResponse403Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetAuthorizedSubscriptionManagementUrlResponse403Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetAuthorizedSubscriptionManagementUrlResponse403Type(d.pop("type"))
        ...
        get_authorized_subscription_management_url_response_403 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_authorized_subscription_management_url_response_403.additional_properties = d
        return get_authorized_subscription_management_url_response_403
