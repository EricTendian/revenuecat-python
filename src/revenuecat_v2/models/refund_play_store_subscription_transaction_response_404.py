...
from ..models.refund_play_store_subscription_transaction_response_404_type import (
    RefundPlayStoreSubscriptionTransactionResponse404Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RefundPlayStoreSubscriptionTransactionResponse404")


@_attrs_define
class RefundPlayStoreSubscriptionTransactionResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (RefundPlayStoreSubscriptionTransactionResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: RefundPlayStoreSubscriptionTransactionResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = RefundPlayStoreSubscriptionTransactionResponse404Type(d.pop("type"))
        ...
        refund_play_store_subscription_transaction_response_404 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        refund_play_store_subscription_transaction_response_404.additional_properties = d
        return refund_play_store_subscription_transaction_response_404
