...
from ..models.create_app_response_404_type import CreateAppResponse404Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateAppResponse404")


@_attrs_define
class CreateAppResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (CreateAppResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: CreateAppResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CreateAppResponse404Type(d.pop("type"))
        ...
        create_app_response_404.additional_properties = d
        return create_app_response_404
