...
from ..models.get_webhook_integration_response_401_type import GetWebhookIntegrationResponse401Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetWebhookIntegrationResponse401")


@_attrs_define
class GetWebhookIntegrationResponse401:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetWebhookIntegrationResponse401Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetWebhookIntegrationResponse401Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetWebhookIntegrationResponse401Type(d.pop("type"))
        ...
        get_webhook_integration_response_401 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_webhook_integration_response_401.additional_properties = d
        return get_webhook_integration_response_401
