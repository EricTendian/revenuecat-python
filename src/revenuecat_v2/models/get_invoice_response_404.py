...
from ..models.get_invoice_response_404_type import GetInvoiceResponse404Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetInvoiceResponse404")


@_attrs_define
class GetInvoiceResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetInvoiceResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetInvoiceResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetInvoiceResponse404Type(d.pop("type"))
        ...
        get_invoice_response_404.additional_properties = d
        return get_invoice_response_404
