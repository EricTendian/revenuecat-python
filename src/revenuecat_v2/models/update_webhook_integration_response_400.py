...
from ..models.update_webhook_integration_response_400_type import UpdateWebhookIntegrationResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateWebhookIntegrationResponse400")


@_attrs_define
class UpdateWebhookIntegrationResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (UpdateWebhookIntegrationResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: UpdateWebhookIntegrationResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = UpdateWebhookIntegrationResponse400Type(d.pop("type"))
        ...
        update_webhook_integration_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        update_webhook_integration_response_400.additional_properties = d
        return update_webhook_integration_response_400
