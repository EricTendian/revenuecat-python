...
from ..models.delete_app_response_429_type import DeleteAppResponse429Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="DeleteAppResponse429")


@_attrs_define
class DeleteAppResponse429:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (DeleteAppResponse429Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: DeleteAppResponse429Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = DeleteAppResponse429Type(d.pop("type"))
        ...
        delete_app_response_429.additional_properties = d
        return delete_app_response_429
