...
from ..models.get_products_from_entitlement_response_400_type import GetProductsFromEntitlementResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetProductsFromEntitlementResponse400")


@_attrs_define
class GetProductsFromEntitlementResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetProductsFromEntitlementResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetProductsFromEntitlementResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetProductsFromEntitlementResponse400Type(d.pop("type"))
        ...
        get_products_from_entitlement_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_products_from_entitlement_response_400.additional_properties = d
        return get_products_from_entitlement_response_400
