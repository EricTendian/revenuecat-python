...
from ..models.create_entitlement_response_503_type import CreateEntitlementResponse503Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateEntitlementResponse503")


@_attrs_define
class CreateEntitlementResponse503:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (CreateEntitlementResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: CreateEntitlementResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CreateEntitlementResponse503Type(d.pop("type"))
        ...
        create_entitlement_response_503 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        create_entitlement_response_503.additional_properties = d
        return create_entitlement_response_503
