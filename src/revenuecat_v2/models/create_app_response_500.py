...
from ..models.create_app_response_500_type import CreateAppResponse500Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateAppResponse500")


@_attrs_define
class CreateAppResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (CreateAppResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: CreateAppResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CreateAppResponse500Type(d.pop("type"))
        ...
        create_app_response_500.additional_properties = d
        return create_app_response_500
