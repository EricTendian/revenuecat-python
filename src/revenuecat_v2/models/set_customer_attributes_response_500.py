...
from ..models.set_customer_attributes_response_500_type import SetCustomerAttributesResponse500Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="SetCustomerAttributesResponse500")


@_attrs_define
class SetCustomerAttributesResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (SetCustomerAttributesResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: SetCustomerAttributesResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = SetCustomerAttributesResponse500Type(d.pop("type"))
        ...
        set_customer_attributes_response_500 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        set_customer_attributes_response_500.additional_properties = d
        return set_customer_attributes_response_500
