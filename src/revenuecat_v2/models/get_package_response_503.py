...
from ..models.get_package_response_503_type import GetPackageResponse503Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetPackageResponse503")


@_attrs_define
class GetPackageResponse503:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetPackageResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetPackageResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetPackageResponse503Type(d.pop("type"))
        ...
        get_package_response_503.additional_properties = d
        return get_package_response_503
