...
from ..models.list_subscription_entitlements_response_401_type import ListSubscriptionEntitlementsResponse401Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListSubscriptionEntitlementsResponse401")


@_attrs_define
class ListSubscriptionEntitlementsResponse401:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListSubscriptionEntitlementsResponse401Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListSubscriptionEntitlementsResponse401Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListSubscriptionEntitlementsResponse401Type(d.pop("type"))
        ...
        list_subscription_entitlements_response_401 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_subscription_entitlements_response_401.additional_properties = d
        return list_subscription_entitlements_response_401
