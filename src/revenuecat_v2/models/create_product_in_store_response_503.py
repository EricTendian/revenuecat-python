...
from ..models.create_product_in_store_response_503_type import CreateProductInStoreResponse503Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateProductInStoreResponse503")


@_attrs_define
class CreateProductInStoreResponse503:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (CreateProductInStoreResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: CreateProductInStoreResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CreateProductInStoreResponse503Type(d.pop("type"))
        ...
        create_product_in_store_response_503 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        create_product_in_store_response_503.additional_properties = d
        return create_product_in_store_response_503
