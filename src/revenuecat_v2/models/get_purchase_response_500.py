...
from ..models.get_purchase_response_500_type import GetPurchaseResponse500Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetPurchaseResponse500")


@_attrs_define
class GetPurchaseResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetPurchaseResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetPurchaseResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetPurchaseResponse500Type(d.pop("type"))
        ...
        get_purchase_response_500.additional_properties = d
        return get_purchase_response_500
