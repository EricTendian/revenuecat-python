...
from ..models.grant_customer_entitlement_response_422_type import GrantCustomerEntitlementResponse422Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GrantCustomerEntitlementResponse422")


@_attrs_define
class GrantCustomerEntitlementResponse422:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GrantCustomerEntitlementResponse422Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GrantCustomerEntitlementResponse422Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GrantCustomerEntitlementResponse422Type(d.pop("type"))
        ...
        grant_customer_entitlement_response_422 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        grant_customer_entitlement_response_422.additional_properties = d
        return grant_customer_entitlement_response_422
