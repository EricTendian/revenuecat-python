...
from ..models.list_entitlements_response_401_type import ListEntitlementsResponse401Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListEntitlementsResponse401")


@_attrs_define
class ListEntitlementsResponse401:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListEntitlementsResponse401Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListEntitlementsResponse401Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListEntitlementsResponse401Type(d.pop("type"))
        ...
        list_entitlements_response_401 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_entitlements_response_401.additional_properties = d
        return list_entitlements_response_401
