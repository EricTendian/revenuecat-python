...
class RCBillingAppRcBilling:
    ...
    Attributes:
        ...
        app_name (str | Unset): Shown in checkout, emails, and receipts sent to customers.
        seller_company_support_email (None | str | Unset): The company support email. This field is deprecated. Please,
            use `support_email` instead.
        support_email (None | str | Unset): Used as the `reply to` address in all emails sent to customers, to allow
            them to receive support.
    """
    ...
    seller_company_support_email: None | str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        seller_company_support_email: None | str | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_seller_company_support_email(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        seller_company_support_email = _parse_seller_company_support_email(d.pop("seller_company_support_email", UNSET))
