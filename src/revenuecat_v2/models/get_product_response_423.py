...
from ..models.get_product_response_423_type import GetProductResponse423Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetProductResponse423")


@_attrs_define
class GetProductResponse423:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetProductResponse423Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetProductResponse423Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetProductResponse423Type(d.pop("type"))
        ...
        get_product_response_423.additional_properties = d
        return get_product_response_423
