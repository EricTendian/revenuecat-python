...
from ..models.get_play_store_subscription_transactions_response_500_type import (
    GetPlayStoreSubscriptionTransactionsResponse500Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetPlayStoreSubscriptionTransactionsResponse500")


@_attrs_define
class GetPlayStoreSubscriptionTransactionsResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetPlayStoreSubscriptionTransactionsResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetPlayStoreSubscriptionTransactionsResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetPlayStoreSubscriptionTransactionsResponse500Type(d.pop("type"))
        ...
        get_play_store_subscription_transactions_response_500 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_play_store_subscription_transactions_response_500.additional_properties = d
        return get_play_store_subscription_transactions_response_500
