...
from ..models.update_app_response_429_type import UpdateAppResponse429Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateAppResponse429")


@_attrs_define
class UpdateAppResponse429:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (UpdateAppResponse429Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: UpdateAppResponse429Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = UpdateAppResponse429Type(d.pop("type"))
        ...
        update_app_response_429.additional_properties = d
        return update_app_response_429
