...
from ..models.create_customer_response_409_type import CreateCustomerResponse409Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateCustomerResponse409")


@_attrs_define
class CreateCustomerResponse409:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (CreateCustomerResponse409Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: CreateCustomerResponse409Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CreateCustomerResponse409Type(d.pop("type"))
        ...
        create_customer_response_409 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        create_customer_response_409.additional_properties = d
        return create_customer_response_409
