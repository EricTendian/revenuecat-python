...
from ..models.get_app_response_500_type import GetAppResponse500Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetAppResponse500")


@_attrs_define
class GetAppResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetAppResponse500Type): The error type Example: parameter_error.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetAppResponse500Type(d.pop("type"))
        ...
        get_app_response_500.additional_properties = d
        return get_app_response_500
