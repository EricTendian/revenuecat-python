...
from ..models.update_app_response_400_type import UpdateAppResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateAppResponse400")


@_attrs_define
class UpdateAppResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (UpdateAppResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: UpdateAppResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = UpdateAppResponse400Type(d.pop("type"))
        ...
        update_app_response_400.additional_properties = d
        return update_app_response_400
