...
from ..models.update_offering_response_400_type import UpdateOfferingResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateOfferingResponse400")


@_attrs_define
class UpdateOfferingResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (UpdateOfferingResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: UpdateOfferingResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = UpdateOfferingResponse400Type(d.pop("type"))
        ...
        update_offering_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        update_offering_response_400.additional_properties = d
        return update_offering_response_400
