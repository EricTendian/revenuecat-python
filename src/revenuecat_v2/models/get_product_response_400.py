...
from ..models.get_product_response_400_type import GetProductResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetProductResponse400")


@_attrs_define
class GetProductResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetProductResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetProductResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetProductResponse400Type(d.pop("type"))
        ...
        get_product_response_400.additional_properties = d
        return get_product_response_400
