...
from ..models.get_offering_response_400_type import GetOfferingResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetOfferingResponse400")


@_attrs_define
class GetOfferingResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetOfferingResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetOfferingResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetOfferingResponse400Type(d.pop("type"))
        ...
        get_offering_response_400.additional_properties = d
        return get_offering_response_400
