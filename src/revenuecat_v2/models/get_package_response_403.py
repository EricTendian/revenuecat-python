...
from ..models.get_package_response_403_type import GetPackageResponse403Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetPackageResponse403")


@_attrs_define
class GetPackageResponse403:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetPackageResponse403Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetPackageResponse403Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetPackageResponse403Type(d.pop("type"))
        ...
        get_package_response_403.additional_properties = d
        return get_package_response_403
