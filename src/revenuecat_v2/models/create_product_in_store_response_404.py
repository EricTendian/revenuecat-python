...
from ..models.create_product_in_store_response_404_type import CreateProductInStoreResponse404Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateProductInStoreResponse404")


@_attrs_define
class CreateProductInStoreResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (CreateProductInStoreResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: CreateProductInStoreResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CreateProductInStoreResponse404Type(d.pop("type"))
        ...
        create_product_in_store_response_404 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        create_product_in_store_response_404.additional_properties = d
        return create_product_in_store_response_404
