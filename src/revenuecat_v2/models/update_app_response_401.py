...
from ..models.update_app_response_401_type import UpdateAppResponse401Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateAppResponse401")


@_attrs_define
class UpdateAppResponse401:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (UpdateAppResponse401Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: UpdateAppResponse401Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = UpdateAppResponse401Type(d.pop("type"))
        ...
        update_app_response_401.additional_properties = d
        return update_app_response_401
