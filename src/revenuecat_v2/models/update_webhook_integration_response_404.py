...
from ..models.update_webhook_integration_response_404_type import UpdateWebhookIntegrationResponse404Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateWebhookIntegrationResponse404")


@_attrs_define
class UpdateWebhookIntegrationResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (UpdateWebhookIntegrationResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: UpdateWebhookIntegrationResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = UpdateWebhookIntegrationResponse404Type(d.pop("type"))
        ...
        update_webhook_integration_response_404 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        update_webhook_integration_response_404.additional_properties = d
        return update_webhook_integration_response_404
