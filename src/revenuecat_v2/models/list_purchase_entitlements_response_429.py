...
from ..models.list_purchase_entitlements_response_429_type import ListPurchaseEntitlementsResponse429Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListPurchaseEntitlementsResponse429")


@_attrs_define
class ListPurchaseEntitlementsResponse429:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListPurchaseEntitlementsResponse429Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListPurchaseEntitlementsResponse429Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListPurchaseEntitlementsResponse429Type(d.pop("type"))
        ...
        list_purchase_entitlements_response_429 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_purchase_entitlements_response_429.additional_properties = d
        return list_purchase_entitlements_response_429
