...
from ..models.set_customer_attributes_response_409_type import SetCustomerAttributesResponse409Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="SetCustomerAttributesResponse409")


@_attrs_define
class SetCustomerAttributesResponse409:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (SetCustomerAttributesResponse409Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: SetCustomerAttributesResponse409Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = SetCustomerAttributesResponse409Type(d.pop("type"))
        ...
        set_customer_attributes_response_409 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        set_customer_attributes_response_409.additional_properties = d
        return set_customer_attributes_response_409
