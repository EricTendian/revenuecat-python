...
from ..models.set_customer_attributes_response_422_type import SetCustomerAttributesResponse422Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="SetCustomerAttributesResponse422")


@_attrs_define
class SetCustomerAttributesResponse422:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (SetCustomerAttributesResponse422Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: SetCustomerAttributesResponse422Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = SetCustomerAttributesResponse422Type(d.pop("type"))
        ...
        set_customer_attributes_response_422 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        set_customer_attributes_response_422.additional_properties = d
        return set_customer_attributes_response_422
