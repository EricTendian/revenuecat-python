...
from ..models.get_invoice_response_423_type import GetInvoiceResponse423Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetInvoiceResponse423")


@_attrs_define
class GetInvoiceResponse423:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetInvoiceResponse423Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetInvoiceResponse423Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetInvoiceResponse423Type(d.pop("type"))
        ...
        get_invoice_response_423.additional_properties = d
        return get_invoice_response_423
