...
from ..models.get_invoice_response_500_type import GetInvoiceResponse500Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetInvoiceResponse500")


@_attrs_define
class GetInvoiceResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetInvoiceResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetInvoiceResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetInvoiceResponse500Type(d.pop("type"))
        ...
        get_invoice_response_500.additional_properties = d
        return get_invoice_response_500
