...
from ..models.refund_play_store_subscription_transaction_response_401_type import (
    RefundPlayStoreSubscriptionTransactionResponse401Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RefundPlayStoreSubscriptionTransactionResponse401")


@_attrs_define
class RefundPlayStoreSubscriptionTransactionResponse401:
    """
    Example:
        {'object': 'error', 'type': 'authentication_error', 'message': 'Invalid API key', 'retryable': False, 'doc_url':
            'https://errors.rev.cat/authentication-error'}

    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (RefundPlayStoreSubscriptionTransactionResponse401Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: RefundPlayStoreSubscriptionTransactionResponse401Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = RefundPlayStoreSubscriptionTransactionResponse401Type(d.pop("type"))
        ...
        refund_play_store_subscription_transaction_response_401 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        refund_play_store_subscription_transaction_response_401.additional_properties = d
        return refund_play_store_subscription_transaction_response_401
