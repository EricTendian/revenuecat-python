...
from ..models.list_customer_attributes_response_503_type import ListCustomerAttributesResponse503Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListCustomerAttributesResponse503")


@_attrs_define
class ListCustomerAttributesResponse503:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListCustomerAttributesResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListCustomerAttributesResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListCustomerAttributesResponse503Type(d.pop("type"))
        ...
        list_customer_attributes_response_503 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_customer_attributes_response_503.additional_properties = d
        return list_customer_attributes_response_503
