...
from ..models.get_purchase_response_403_type import GetPurchaseResponse403Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetPurchaseResponse403")


@_attrs_define
class GetPurchaseResponse403:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetPurchaseResponse403Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetPurchaseResponse403Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetPurchaseResponse403Type(d.pop("type"))
        ...
        get_purchase_response_403.additional_properties = d
        return get_purchase_response_403
