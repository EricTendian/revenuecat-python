...
from ..models.get_purchase_response_423_type import GetPurchaseResponse423Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetPurchaseResponse423")


@_attrs_define
class GetPurchaseResponse423:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetPurchaseResponse423Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetPurchaseResponse423Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetPurchaseResponse423Type(d.pop("type"))
        ...
        get_purchase_response_423.additional_properties = d
        return get_purchase_response_423
