...
from ..models.get_invoice_response_503_type import GetInvoiceResponse503Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetInvoiceResponse503")


@_attrs_define
class GetInvoiceResponse503:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetInvoiceResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetInvoiceResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetInvoiceResponse503Type(d.pop("type"))
        ...
        get_invoice_response_503.additional_properties = d
        return get_invoice_response_503
