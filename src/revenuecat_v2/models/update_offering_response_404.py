...
from ..models.update_offering_response_404_type import UpdateOfferingResponse404Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateOfferingResponse404")


@_attrs_define
class UpdateOfferingResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (UpdateOfferingResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: UpdateOfferingResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = UpdateOfferingResponse404Type(d.pop("type"))
        ...
        update_offering_response_404 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        update_offering_response_404.additional_properties = d
        return update_offering_response_404
