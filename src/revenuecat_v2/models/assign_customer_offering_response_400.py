...
from ..models.assign_customer_offering_response_400_type import AssignCustomerOfferingResponse400Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="AssignCustomerOfferingResponse400")


@_attrs_define
class AssignCustomerOfferingResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (AssignCustomerOfferingResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: AssignCustomerOfferingResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = AssignCustomerOfferingResponse400Type(d.pop("type"))
        ...
        assign_customer_offering_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        assign_customer_offering_response_400.additional_properties = d
        return assign_customer_offering_response_400
