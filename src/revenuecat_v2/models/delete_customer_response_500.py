...
from ..models.delete_customer_response_500_type import DeleteCustomerResponse500Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="DeleteCustomerResponse500")


@_attrs_define
class DeleteCustomerResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (DeleteCustomerResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: DeleteCustomerResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = DeleteCustomerResponse500Type(d.pop("type"))
        ...
        delete_customer_response_500 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        delete_customer_response_500.additional_properties = d
        return delete_customer_response_500
