...
from ..models.refund_subscription_response_404_type import RefundSubscriptionResponse404Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="RefundSubscriptionResponse404")


@_attrs_define
class RefundSubscriptionResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (RefundSubscriptionResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: RefundSubscriptionResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = RefundSubscriptionResponse404Type(d.pop("type"))
        ...
        refund_subscription_response_404 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        refund_subscription_response_404.additional_properties = d
        return refund_subscription_response_404
