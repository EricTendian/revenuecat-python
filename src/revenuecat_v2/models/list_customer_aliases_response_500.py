...
from ..models.list_customer_aliases_response_500_type import ListCustomerAliasesResponse500Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListCustomerAliasesResponse500")


@_attrs_define
class ListCustomerAliasesResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListCustomerAliasesResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListCustomerAliasesResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListCustomerAliasesResponse500Type(d.pop("type"))
        ...
        list_customer_aliases_response_500 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_customer_aliases_response_500.additional_properties = d
        return list_customer_aliases_response_500
