...
from ..models.refund_subscription_response_429_type import RefundSubscriptionResponse429Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="RefundSubscriptionResponse429")


@_attrs_define
class RefundSubscriptionResponse429:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (RefundSubscriptionResponse429Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: RefundSubscriptionResponse429Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = RefundSubscriptionResponse429Type(d.pop("type"))
        ...
        refund_subscription_response_429 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        refund_subscription_response_429.additional_properties = d
        return refund_subscription_response_429
