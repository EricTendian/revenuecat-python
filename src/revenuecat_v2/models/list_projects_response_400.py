...
from ..models.list_projects_response_400_type import ListProjectsResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListProjectsResponse400")


@_attrs_define
class ListProjectsResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListProjectsResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListProjectsResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListProjectsResponse400Type(d.pop("type"))
        ...
        list_projects_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_projects_response_400.additional_properties = d
        return list_projects_response_400
