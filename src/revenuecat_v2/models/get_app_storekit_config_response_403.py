...
from ..models.get_app_storekit_config_response_403_type import GetAppStorekitConfigResponse403Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetAppStorekitConfigResponse403")


@_attrs_define
class GetAppStorekitConfigResponse403:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetAppStorekitConfigResponse403Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetAppStorekitConfigResponse403Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetAppStorekitConfigResponse403Type(d.pop("type"))
        ...
        get_app_storekit_config_response_403 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_app_storekit_config_response_403.additional_properties = d
        return get_app_storekit_config_response_403
