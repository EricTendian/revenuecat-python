...
from ..models.list_purchases_response_403_type import ListPurchasesResponse403Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListPurchasesResponse403")


@_attrs_define
class ListPurchasesResponse403:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListPurchasesResponse403Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListPurchasesResponse403Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListPurchasesResponse403Type(d.pop("type"))
        ...
        list_purchases_response_403 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_purchases_response_403.additional_properties = d
        return list_purchases_response_403
