...
from ..models.get_offering_response_401_type import GetOfferingResponse401Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetOfferingResponse401")


@_attrs_define
class GetOfferingResponse401:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetOfferingResponse401Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetOfferingResponse401Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetOfferingResponse401Type(d.pop("type"))
        ...
        get_offering_response_401.additional_properties = d
        return get_offering_response_401
