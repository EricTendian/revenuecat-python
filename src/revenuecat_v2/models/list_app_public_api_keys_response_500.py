...
from ..models.list_app_public_api_keys_response_500_type import ListAppPublicApiKeysResponse500Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListAppPublicApiKeysResponse500")


@_attrs_define
class ListAppPublicApiKeysResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListAppPublicApiKeysResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListAppPublicApiKeysResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListAppPublicApiKeysResponse500Type(d.pop("type"))
        ...
        list_app_public_api_keys_response_500 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_app_public_api_keys_response_500.additional_properties = d
        return list_app_public_api_keys_response_500
