...
from ..models.get_customer_response_403_type import GetCustomerResponse403Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetCustomerResponse403")


@_attrs_define
class GetCustomerResponse403:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetCustomerResponse403Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetCustomerResponse403Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetCustomerResponse403Type(d.pop("type"))
        ...
        get_customer_response_403.additional_properties = d
        return get_customer_response_403
