...
from ..models.delete_webhook_integration_response_403_type import DeleteWebhookIntegrationResponse403Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="DeleteWebhookIntegrationResponse403")


@_attrs_define
class DeleteWebhookIntegrationResponse403:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (DeleteWebhookIntegrationResponse403Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: DeleteWebhookIntegrationResponse403Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = DeleteWebhookIntegrationResponse403Type(d.pop("type"))
        ...
        delete_webhook_integration_response_403 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        delete_webhook_integration_response_403.additional_properties = d
        return delete_webhook_integration_response_403
