...
from ..models.delete_webhook_integration_response_401_type import DeleteWebhookIntegrationResponse401Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="DeleteWebhookIntegrationResponse401")


@_attrs_define
class DeleteWebhookIntegrationResponse401:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (DeleteWebhookIntegrationResponse401Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: DeleteWebhookIntegrationResponse401Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = DeleteWebhookIntegrationResponse401Type(d.pop("type"))
        ...
        delete_webhook_integration_response_401 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        delete_webhook_integration_response_401.additional_properties = d
        return delete_webhook_integration_response_401
