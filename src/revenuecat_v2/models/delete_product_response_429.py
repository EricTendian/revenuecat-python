...
from ..models.delete_product_response_429_type import DeleteProductResponse429Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="DeleteProductResponse429")


@_attrs_define
class DeleteProductResponse429:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (DeleteProductResponse429Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: DeleteProductResponse429Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = DeleteProductResponse429Type(d.pop("type"))
        ...
        delete_product_response_429 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        delete_product_response_429.additional_properties = d
        return delete_product_response_429
