...
from ..models.search_subscriptions_response_429_type import SearchSubscriptionsResponse429Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="SearchSubscriptionsResponse429")


@_attrs_define
class SearchSubscriptionsResponse429:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (SearchSubscriptionsResponse429Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: SearchSubscriptionsResponse429Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = SearchSubscriptionsResponse429Type(d.pop("type"))
        ...
        search_subscriptions_response_429 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        search_subscriptions_response_429.additional_properties = d
        return search_subscriptions_response_429
