...
from ..models.refund_play_store_subscription_transaction_response_503_type import (
    RefundPlayStoreSubscriptionTransactionResponse503Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RefundPlayStoreSubscriptionTransactionResponse503")


@_attrs_define
class RefundPlayStoreSubscriptionTransactionResponse503:
    """
    Example:
        {'object': 'error', 'type': 'server_error', 'message': 'There was an internal server error', 'retryable': True,
            'doc_url': 'https://errors.rev.cat/server-error', 'backoff_ms': 1000}

    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (RefundPlayStoreSubscriptionTransactionResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: RefundPlayStoreSubscriptionTransactionResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = RefundPlayStoreSubscriptionTransactionResponse503Type(d.pop("type"))
        ...
        refund_play_store_subscription_transaction_response_503 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        refund_play_store_subscription_transaction_response_503.additional_properties = d
        return refund_play_store_subscription_transaction_response_503
