...
from ..models.list_customer_attributes_response_429_type import ListCustomerAttributesResponse429Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListCustomerAttributesResponse429")


@_attrs_define
class ListCustomerAttributesResponse429:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListCustomerAttributesResponse429Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListCustomerAttributesResponse429Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListCustomerAttributesResponse429Type(d.pop("type"))
        ...
        list_customer_attributes_response_429 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_customer_attributes_response_429.additional_properties = d
        return list_customer_attributes_response_429
