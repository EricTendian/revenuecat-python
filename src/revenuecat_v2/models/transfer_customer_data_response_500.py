...
from ..models.transfer_customer_data_response_500_type import TransferCustomerDataResponse500Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="TransferCustomerDataResponse500")


@_attrs_define
class TransferCustomerDataResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (TransferCustomerDataResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: TransferCustomerDataResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = TransferCustomerDataResponse500Type(d.pop("type"))
        ...
        transfer_customer_data_response_500 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        transfer_customer_data_response_500.additional_properties = d
        return transfer_customer_data_response_500
