...
from ..models.list_customer_active_entitlements_response_503_type import ListCustomerActiveEntitlementsResponse503Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListCustomerActiveEntitlementsResponse503")


@_attrs_define
class ListCustomerActiveEntitlementsResponse503:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListCustomerActiveEntitlementsResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListCustomerActiveEntitlementsResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListCustomerActiveEntitlementsResponse503Type(d.pop("type"))
        ...
        list_customer_active_entitlements_response_503 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_customer_active_entitlements_response_503.additional_properties = d
        return list_customer_active_entitlements_response_503
