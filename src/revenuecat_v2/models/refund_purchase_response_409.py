...
from ..models.refund_purchase_response_409_type import RefundPurchaseResponse409Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="RefundPurchaseResponse409")


@_attrs_define
class RefundPurchaseResponse409:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (RefundPurchaseResponse409Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: RefundPurchaseResponse409Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = RefundPurchaseResponse409Type(d.pop("type"))
        ...
        refund_purchase_response_409 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        refund_purchase_response_409.additional_properties = d
        return refund_purchase_response_409
