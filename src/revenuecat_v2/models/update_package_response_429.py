...
from ..models.update_package_response_429_type import UpdatePackageResponse429Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdatePackageResponse429")


@_attrs_define
class UpdatePackageResponse429:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (UpdatePackageResponse429Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: UpdatePackageResponse429Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = UpdatePackageResponse429Type(d.pop("type"))
        ...
        update_package_response_429 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        update_package_response_429.additional_properties = d
        return update_package_response_429
