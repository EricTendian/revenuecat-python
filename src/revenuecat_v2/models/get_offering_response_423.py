...
from ..models.get_offering_response_423_type import GetOfferingResponse423Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetOfferingResponse423")


@_attrs_define
class GetOfferingResponse423:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetOfferingResponse423Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetOfferingResponse423Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetOfferingResponse423Type(d.pop("type"))
        ...
        get_offering_response_423.additional_properties = d
        return get_offering_response_423
