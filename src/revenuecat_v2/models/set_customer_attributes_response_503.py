...
from ..models.set_customer_attributes_response_503_type import SetCustomerAttributesResponse503Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="SetCustomerAttributesResponse503")


@_attrs_define
class SetCustomerAttributesResponse503:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (SetCustomerAttributesResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: SetCustomerAttributesResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = SetCustomerAttributesResponse503Type(d.pop("type"))
        ...
        set_customer_attributes_response_503 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        set_customer_attributes_response_503.additional_properties = d
        return set_customer_attributes_response_503
