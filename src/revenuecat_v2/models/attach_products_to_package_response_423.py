...
from ..models.attach_products_to_package_response_423_type import AttachProductsToPackageResponse423Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="AttachProductsToPackageResponse423")


@_attrs_define
class AttachProductsToPackageResponse423:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (AttachProductsToPackageResponse423Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: AttachProductsToPackageResponse423Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = AttachProductsToPackageResponse423Type(d.pop("type"))
        ...
        attach_products_to_package_response_423 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        attach_products_to_package_response_423.additional_properties = d
        return attach_products_to_package_response_423
