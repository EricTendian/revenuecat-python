...
from ..models.list_entitlements_response_403_type import ListEntitlementsResponse403Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListEntitlementsResponse403")


@_attrs_define
class ListEntitlementsResponse403:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListEntitlementsResponse403Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListEntitlementsResponse403Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListEntitlementsResponse403Type(d.pop("type"))
        ...
        list_entitlements_response_403 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_entitlements_response_403.additional_properties = d
        return list_entitlements_response_403
