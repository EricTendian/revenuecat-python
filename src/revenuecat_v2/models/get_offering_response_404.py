...
from ..models.get_offering_response_404_type import GetOfferingResponse404Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetOfferingResponse404")


@_attrs_define
class GetOfferingResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetOfferingResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetOfferingResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetOfferingResponse404Type(d.pop("type"))
        ...
        get_offering_response_404.additional_properties = d
        return get_offering_response_404
