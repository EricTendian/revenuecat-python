...
from ..models.update_webhook_integration_response_403_type import UpdateWebhookIntegrationResponse403Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateWebhookIntegrationResponse403")


@_attrs_define
class UpdateWebhookIntegrationResponse403:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (UpdateWebhookIntegrationResponse403Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: UpdateWebhookIntegrationResponse403Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = UpdateWebhookIntegrationResponse403Type(d.pop("type"))
        ...
        update_webhook_integration_response_403 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        update_webhook_integration_response_403.additional_properties = d
        return update_webhook_integration_response_403
