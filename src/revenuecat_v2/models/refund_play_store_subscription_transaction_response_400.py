...
from ..models.refund_play_store_subscription_transaction_response_400_type import (
    RefundPlayStoreSubscriptionTransactionResponse400Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RefundPlayStoreSubscriptionTransactionResponse400")


@_attrs_define
class RefundPlayStoreSubscriptionTransactionResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (RefundPlayStoreSubscriptionTransactionResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: RefundPlayStoreSubscriptionTransactionResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = RefundPlayStoreSubscriptionTransactionResponse400Type(d.pop("type"))
        ...
        refund_play_store_subscription_transaction_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        refund_play_store_subscription_transaction_response_400.additional_properties = d
        return refund_play_store_subscription_transaction_response_400
