...
from ..models.delete_product_response_400_type import DeleteProductResponse400Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="DeleteProductResponse400")


@_attrs_define
class DeleteProductResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (DeleteProductResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: DeleteProductResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = DeleteProductResponse400Type(d.pop("type"))
        ...
        delete_product_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        delete_product_response_400.additional_properties = d
        return delete_product_response_400
