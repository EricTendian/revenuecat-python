...
from ..models.list_customers_response_503_type import ListCustomersResponse503Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListCustomersResponse503")


@_attrs_define
class ListCustomersResponse503:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListCustomersResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListCustomersResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListCustomersResponse503Type(d.pop("type"))
        ...
        list_customers_response_503 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_customers_response_503.additional_properties = d
        return list_customers_response_503
