...
from ..models.delete_offering_response_423_type import DeleteOfferingResponse423Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="DeleteOfferingResponse423")


@_attrs_define
class DeleteOfferingResponse423:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (DeleteOfferingResponse423Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: DeleteOfferingResponse423Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = DeleteOfferingResponse423Type(d.pop("type"))
        ...
        delete_offering_response_423 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        delete_offering_response_423.additional_properties = d
        return delete_offering_response_423
