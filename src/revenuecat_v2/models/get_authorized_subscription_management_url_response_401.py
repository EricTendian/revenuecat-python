...
from ..models.get_authorized_subscription_management_url_response_401_type import (
    GetAuthorizedSubscriptionManagementUrlResponse401Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetAuthorizedSubscriptionManagementUrlResponse401")


@_attrs_define
class GetAuthorizedSubscriptionManagementUrlResponse401:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetAuthorizedSubscriptionManagementUrlResponse401Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetAuthorizedSubscriptionManagementUrlResponse401Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetAuthorizedSubscriptionManagementUrlResponse401Type(d.pop("type"))
        ...
        get_authorized_subscription_management_url_response_401 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_authorized_subscription_management_url_response_401.additional_properties = d
        return get_authorized_subscription_management_url_response_401
