...
from ..models.delete_offering_response_400_type import DeleteOfferingResponse400Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="DeleteOfferingResponse400")


@_attrs_define
class DeleteOfferingResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (DeleteOfferingResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: DeleteOfferingResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = DeleteOfferingResponse400Type(d.pop("type"))
        ...
        delete_offering_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        delete_offering_response_400.additional_properties = d
        return delete_offering_response_400
