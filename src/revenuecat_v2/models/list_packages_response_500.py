...
from ..models.list_packages_response_500_type import ListPackagesResponse500Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListPackagesResponse500")


@_attrs_define
class ListPackagesResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListPackagesResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListPackagesResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListPackagesResponse500Type(d.pop("type"))
        ...
        list_packages_response_500 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_packages_response_500.additional_properties = d
        return list_packages_response_500
