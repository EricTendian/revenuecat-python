...
from ..models.get_products_from_package_response_423_type import GetProductsFromPackageResponse423Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetProductsFromPackageResponse423")


@_attrs_define
class GetProductsFromPackageResponse423:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetProductsFromPackageResponse423Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetProductsFromPackageResponse423Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetProductsFromPackageResponse423Type(d.pop("type"))
        ...
        get_products_from_package_response_423 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_products_from_package_response_423.additional_properties = d
        return get_products_from_package_response_423
