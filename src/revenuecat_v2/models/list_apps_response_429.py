...
from ..models.list_apps_response_429_type import ListAppsResponse429Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListAppsResponse429")


@_attrs_define
class ListAppsResponse429:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListAppsResponse429Type): The error type Example: parameter_error.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListAppsResponse429Type(d.pop("type"))
        ...
        list_apps_response_429.additional_properties = d
        return list_apps_response_429
