...
from ..models.get_product_response_403_type import GetProductResponse403Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetProductResponse403")


@_attrs_define
class GetProductResponse403:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetProductResponse403Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetProductResponse403Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetProductResponse403Type(d.pop("type"))
        ...
        get_product_response_403.additional_properties = d
        return get_product_response_403
