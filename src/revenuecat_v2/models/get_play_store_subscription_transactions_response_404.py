...
from ..models.get_play_store_subscription_transactions_response_404_type import (
    GetPlayStoreSubscriptionTransactionsResponse404Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetPlayStoreSubscriptionTransactionsResponse404")


@_attrs_define
class GetPlayStoreSubscriptionTransactionsResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetPlayStoreSubscriptionTransactionsResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetPlayStoreSubscriptionTransactionsResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetPlayStoreSubscriptionTransactionsResponse404Type(d.pop("type"))
        ...
        get_play_store_subscription_transactions_response_404 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_play_store_subscription_transactions_response_404.additional_properties = d
        return get_play_store_subscription_transactions_response_404
