...
from ..models.list_customers_response_500_type import ListCustomersResponse500Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListCustomersResponse500")


@_attrs_define
class ListCustomersResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListCustomersResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListCustomersResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListCustomersResponse500Type(d.pop("type"))
        ...
        list_customers_response_500 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_customers_response_500.additional_properties = d
        return list_customers_response_500
