...
from ..models.grant_customer_entitlement_response_429_type import GrantCustomerEntitlementResponse429Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GrantCustomerEntitlementResponse429")


@_attrs_define
class GrantCustomerEntitlementResponse429:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GrantCustomerEntitlementResponse429Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GrantCustomerEntitlementResponse429Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GrantCustomerEntitlementResponse429Type(d.pop("type"))
        ...
        grant_customer_entitlement_response_429 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        grant_customer_entitlement_response_429.additional_properties = d
        return grant_customer_entitlement_response_429
