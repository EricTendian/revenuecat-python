...
from ..models.get_customer_response_503_type import GetCustomerResponse503Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetCustomerResponse503")


@_attrs_define
class GetCustomerResponse503:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetCustomerResponse503Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetCustomerResponse503Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetCustomerResponse503Type(d.pop("type"))
        ...
        get_customer_response_503.additional_properties = d
        return get_customer_response_503
