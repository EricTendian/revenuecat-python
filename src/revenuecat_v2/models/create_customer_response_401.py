...
from ..models.create_customer_response_401_type import CreateCustomerResponse401Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateCustomerResponse401")


@_attrs_define
class CreateCustomerResponse401:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (CreateCustomerResponse401Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: CreateCustomerResponse401Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CreateCustomerResponse401Type(d.pop("type"))
        ...
        create_customer_response_401 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        create_customer_response_401.additional_properties = d
        return create_customer_response_401
