...
from ..models.update_entitlement_response_423_type import UpdateEntitlementResponse423Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateEntitlementResponse423")


@_attrs_define
class UpdateEntitlementResponse423:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (UpdateEntitlementResponse423Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: UpdateEntitlementResponse423Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = UpdateEntitlementResponse423Type(d.pop("type"))
        ...
        update_entitlement_response_423 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        update_entitlement_response_423.additional_properties = d
        return update_entitlement_response_423
