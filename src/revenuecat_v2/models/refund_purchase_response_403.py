...
from ..models.refund_purchase_response_403_type import RefundPurchaseResponse403Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="RefundPurchaseResponse403")


@_attrs_define
class RefundPurchaseResponse403:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (RefundPurchaseResponse403Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: RefundPurchaseResponse403Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = RefundPurchaseResponse403Type(d.pop("type"))
        ...
        refund_purchase_response_403 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        refund_purchase_response_403.additional_properties = d
        return refund_purchase_response_403
