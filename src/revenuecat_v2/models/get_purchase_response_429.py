...
from ..models.get_purchase_response_429_type import GetPurchaseResponse429Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetPurchaseResponse429")


@_attrs_define
class GetPurchaseResponse429:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetPurchaseResponse429Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetPurchaseResponse429Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetPurchaseResponse429Type(d.pop("type"))
        ...
        get_purchase_response_429.additional_properties = d
        return get_purchase_response_429
