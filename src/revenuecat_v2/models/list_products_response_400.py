...
from ..models.list_products_response_400_type import ListProductsResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListProductsResponse400")


@_attrs_define
class ListProductsResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListProductsResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListProductsResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListProductsResponse400Type(d.pop("type"))
        ...
        list_products_response_400 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_products_response_400.additional_properties = d
        return list_products_response_400
