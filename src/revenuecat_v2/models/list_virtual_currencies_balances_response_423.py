...
from ..models.list_virtual_currencies_balances_response_423_type import ListVirtualCurrenciesBalancesResponse423Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListVirtualCurrenciesBalancesResponse423")


@_attrs_define
class ListVirtualCurrenciesBalancesResponse423:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListVirtualCurrenciesBalancesResponse423Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListVirtualCurrenciesBalancesResponse423Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListVirtualCurrenciesBalancesResponse423Type(d.pop("type"))
        ...
        list_virtual_currencies_balances_response_423 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_virtual_currencies_balances_response_423.additional_properties = d
        return list_virtual_currencies_balances_response_423
