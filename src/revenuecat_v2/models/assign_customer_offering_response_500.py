...
from ..models.assign_customer_offering_response_500_type import AssignCustomerOfferingResponse500Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="AssignCustomerOfferingResponse500")


@_attrs_define
class AssignCustomerOfferingResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (AssignCustomerOfferingResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: AssignCustomerOfferingResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = AssignCustomerOfferingResponse500Type(d.pop("type"))
        ...
        assign_customer_offering_response_500 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        assign_customer_offering_response_500.additional_properties = d
        return assign_customer_offering_response_500
