...
from ..models.get_invoice_response_400_type import GetInvoiceResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetInvoiceResponse400")


@_attrs_define
class GetInvoiceResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetInvoiceResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetInvoiceResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetInvoiceResponse400Type(d.pop("type"))
        ...
        get_invoice_response_400.additional_properties = d
        return get_invoice_response_400
