...
from ..models.get_invoice_response_403_type import GetInvoiceResponse403Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetInvoiceResponse403")


@_attrs_define
class GetInvoiceResponse403:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetInvoiceResponse403Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetInvoiceResponse403Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetInvoiceResponse403Type(d.pop("type"))
        ...
        get_invoice_response_403.additional_properties = d
        return get_invoice_response_403
