...
from ..models.create_app_response_400_type import CreateAppResponse400Type
from ..models.error_object import ErrorObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateAppResponse400")


@_attrs_define
class CreateAppResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (CreateAppResponse400Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: CreateAppResponse400Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = CreateAppResponse400Type(d.pop("type"))
        ...
        create_app_response_400.additional_properties = d
        return create_app_response_400
