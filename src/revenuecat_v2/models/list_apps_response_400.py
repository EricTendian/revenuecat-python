...
from ..models.list_apps_response_400_type import ListAppsResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListAppsResponse400")


@_attrs_define
class ListAppsResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListAppsResponse400Type): The error type Example: parameter_error.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListAppsResponse400Type(d.pop("type"))
        ...
        list_apps_response_400.additional_properties = d
        return list_apps_response_400
