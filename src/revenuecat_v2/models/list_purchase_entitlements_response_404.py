...
from ..models.list_purchase_entitlements_response_404_type import ListPurchaseEntitlementsResponse404Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListPurchaseEntitlementsResponse404")


@_attrs_define
class ListPurchaseEntitlementsResponse404:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (ListPurchaseEntitlementsResponse404Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: ListPurchaseEntitlementsResponse404Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = ListPurchaseEntitlementsResponse404Type(d.pop("type"))
        ...
        list_purchase_entitlements_response_404 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        list_purchase_entitlements_response_404.additional_properties = d
        return list_purchase_entitlements_response_404
