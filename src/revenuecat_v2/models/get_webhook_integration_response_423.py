...
from ..models.get_webhook_integration_response_423_type import GetWebhookIntegrationResponse423Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetWebhookIntegrationResponse423")


@_attrs_define
class GetWebhookIntegrationResponse423:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetWebhookIntegrationResponse423Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetWebhookIntegrationResponse423Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetWebhookIntegrationResponse423Type(d.pop("type"))
        ...
        get_webhook_integration_response_423 = cls(
            object_=object_,
            type_=type_,
            message=message,
            retryable=retryable,
        ...
        get_webhook_integration_response_423.additional_properties = d
        return get_webhook_integration_response_423
