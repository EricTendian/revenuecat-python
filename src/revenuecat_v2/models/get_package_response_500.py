...
from ..models.get_package_response_500_type import GetPackageResponse500Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetPackageResponse500")


@_attrs_define
class GetPackageResponse500:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetPackageResponse500Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetPackageResponse500Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetPackageResponse500Type(d.pop("type"))
        ...
        get_package_response_500.additional_properties = d
        return get_package_response_500
