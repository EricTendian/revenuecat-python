...
from ..models.get_product_response_429_type import GetProductResponse429Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetProductResponse429")


@_attrs_define
class GetProductResponse429:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetProductResponse429Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetProductResponse429Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetProductResponse429Type(d.pop("type"))
        ...
        get_product_response_429.additional_properties = d
        return get_product_response_429
