...
from ..models.get_app_response_400_type import GetAppResponse400Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetAppResponse400")


@_attrs_define
class GetAppResponse400:
    """
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetAppResponse400Type): The error type Example: parameter_error.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetAppResponse400Type(d.pop("type"))
        ...
        get_app_response_400.additional_properties = d
        return get_app_response_400
