...
from ..models.get_offering_response_429_type import GetOfferingResponse429Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetOfferingResponse429")


@_attrs_define
class GetOfferingResponse429:
    """
    Example:
    ...
    Attributes:
        object_ (ErrorObject): String representing the object's type. Objects of the same type share the same value.
            Example: error.
        type_ (GetOfferingResponse429Type): The error type Example: parameter_error.
    ...
    object_: ErrorObject
    type_: GetOfferingResponse429Type
    message: str
    retryable: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = GetOfferingResponse429Type(d.pop("type"))
        ...
        get_offering_response_429.additional_properties = d
        return get_offering_response_429
